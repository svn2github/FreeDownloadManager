...
/* Object interface: IWgBHO, ver. 0.0,
   GUID={0xDBDC6466,0x1232,0x4511,{0xB1,0xA5,0x0A,0xBC,0x79,0xEB,0x82,0x91}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IWgBHO_ServerInfo;
...
static const MIDL_SERVER_INFO IWgBHO_ServerInfo = 
    ...
    &IWgBHO_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IWgBHO_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IWgBHO_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(8) _IWgBHOProxyVtbl = 
{
    &IWgBHO_ProxyInfo,
    &IID_IWgBHO,
...
/*  6 */	NdrFcShort( 0x7 ),	/* 7 */
#ifndef _ALPHA_
/*  8 */	NdrFcShort( 0x24 ),	/* x86, MIPS, PPC Stack size/offset = 36 */
#else
...
#endif
/* 38 */	NdrFcShort( 0x3e8 ),	/* Type Offset=1000 */
...
/* 52 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
#ifndef _ALPHA_
