...
#ifndef __DataStretcher_h__
#define __DataStretcher_h__
...
#ifndef __DataStretcherLib_LIBRARY_DEFINED__
#define __DataStretcherLib_LIBRARY_DEFINED__  

   

EXTERN_C const IID LIBID_DataStretcherLib;
