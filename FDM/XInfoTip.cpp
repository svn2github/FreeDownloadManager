...
#define DEFAULT_SHOW_DELAY		5000	// Default show delay (ms)

#define TIMER_HIDE				5000		// Hide timer (ms)
...
//     
/////////////////////////////////////////////////////////////////////
void CXInfoTip::Show(LPCSTR pszCaption, CString szText, BOOL bAutoHide /* = TRUE*/, CPoint *pt /* = NULL */)
{
	if (pt != NULL)
		m_ptOrigin	= *pt;
	else
...
void CXInfoTip::OnTimer( UINT nIDEvent ) 
{
	...
	/////////////////////////////////////////////////////////////////////
	// Show the tip window (no auto hide)
	/////////////////////////////////////////////////////////////////////
	case timerShowNAH:
		KillTimer(m_nTimer);
