...
BOOL vmsTpDownloadMgr::SaveState(LPBYTE lpBuffer, LPDWORD pdwSize)
{
	vmsAUTOLOCKSECTION (m_csDownload);

	#define CHECK_SIZE(need) {if (lpBuffer != NULL && *pdwSize < (UINT)(lpBuffer + need - pbOld)) goto _lSizeErr;}

	LPBYTE pbOld = lpBuffer;
