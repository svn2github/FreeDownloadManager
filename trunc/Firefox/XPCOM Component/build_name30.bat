...
del %1.h > nul
del %1.xpt > nul
copy /Y %1.idl "..\..\Gecko.SDK\30\idl\" > nul
cd "..\..\Gecko.SDK\30\idl\"
del %1.h > nul
del %1.xpt > nul
...
copy /Y "..\..\Gecko.SDK\30\idl\%1.h" .\ > nul
copy /Y "..\..\Gecko.SDK\30\idl\%1.xpt" .\ > nul
@rem make a copy for bin\Release folder...
copy /Y "..\..\Gecko.SDK\30\idl\%1.xpt" ..\extension\Components\ > nul