...
#define NS_DECL_NSIZIPWRITER \
  ...
  NS_IMETHOD AlignStoredFiles(uint16_t aAlignSize); 
...
#define NS_FORWARD_NSIZIPWRITER(_to) \
  ...
  NS_IMETHOD AlignStoredFiles(uint16_t aAlignSize) { return _to AlignStoredFiles(aAlignSize); } 
...
#define NS_FORWARD_SAFE_NSIZIPWRITER(_to) \
  ...
  NS_IMETHOD AlignStoredFiles(uint16_t aAlignSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->AlignStoredFiles(aAlignSize); } 
