...
#define NS_DECL_NSIPROMPT \
  ...
  NS_IMETHOD ConfirmEx(const char16_t * dialogTitle, const char16_t * text, uint32_t buttonFlags, const char16_t * button0Title, const char16_t * button1Title, const char16_t * button2Title, const char16_t * checkMsg, bool *checkValue, int32_t *_retval); \
  ...
  NS_IMETHOD Select(const char16_t * dialogTitle, const char16_t * text, uint32_t count, const char16_t * *selectList, int32_t *outSelection, bool *_retval); 
...
#define NS_FORWARD_NSIPROMPT(_to) \
  ...
  NS_IMETHOD Select(const char16_t * dialogTitle, const char16_t * text, uint32_t count, const char16_t * *selectList, int32_t *outSelection, bool *_retval) { return _to Select(dialogTitle, text, count, selectList, outSelection, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPROMPT(_to) \
  ...
  NS_IMETHOD Select(const char16_t * dialogTitle, const char16_t * text, uint32_t count, const char16_t * *selectList, int32_t *outSelection, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Select(dialogTitle, text, count, selectList, outSelection, _retval); } 
