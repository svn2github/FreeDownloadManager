...
#define NS_FORWARD_NSINAVHISTORYRESULTNODE(_to) \
  ...
  NS_IMETHOD GetPageGuid(nsACString & aPageGuid) { return _to GetPageGuid(aPageGuid); } \
  NS_IMETHOD GetBookmarkGuid(nsACString & aBookmarkGuid) { return _to GetBookmarkGuid(aBookmarkGuid); } 
...
#define NS_FORWARD_SAFE_NSINAVHISTORYRESULTNODE(_to) \
  ...
  NS_IMETHOD GetPageGuid(nsACString & aPageGuid) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPageGuid(aPageGuid); } \
  NS_IMETHOD GetBookmarkGuid(nsACString & aBookmarkGuid) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBookmarkGuid(aBookmarkGuid); } 
...
#define NS_INAVHISTORYCONTAINERRESULTNODE_IID_STR "5bac9734-c0ff-44eb-8d19-da88462ff6da"

#define NS_INAVHISTORYCONTAINERRESULTNODE_IID \
  {0x5bac9734, 0xc0ff, 0x44eb, \
    { 0x8d, 0x19, 0xda, 0x88, 0x46, 0x2f, 0xf6, 0xda }}
...
#define NS_INAVHISTORYQUERYRESULTNODE_IID_STR "a4144c3e-8125-46d5-a719-831bec8095f4"

#define NS_INAVHISTORYQUERYRESULTNODE_IID \
  {0xa4144c3e, 0x8125, 0x46d5, \
    { 0xa7, 0x19, 0x83, 0x1b, 0xec, 0x80, 0x95, 0xf4 }}
