...
#define NS_ILOGINMANAGERSTORAGE_IID_STR "fe0a4e80-d36f-43cc-a37b-4e1906e77257"

#define NS_ILOGINMANAGERSTORAGE_IID \
  {0xfe0a4e80, 0xd36f, 0x43cc, \
    { 0xa3, 0x7b, 0x4e, 0x19, 0x06, 0xe7, 0x72, 0x57 }}
...
#define NS_FORWARD_NSILOGINMANAGERSTORAGE(_to) \
  ...
  NS_IMETHOD GetAllDisabledHosts(uint32_t *count, char16_t * **hostnames) { return _to GetAllDisabledHosts(count, hostnames); } \
...
#define NS_FORWARD_SAFE_NSILOGINMANAGERSTORAGE(_to) \
  ...
  NS_IMETHOD GetAllDisabledHosts(uint32_t *count, char16_t * **hostnames) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllDisabledHosts(count, hostnames); } \
...
/* void initWithFile (in nsIFile aFile); */
NS_IMETHODIMP nsLoginManagerStorage::InitWithFile(nsIFile *aFile)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
