...
#define NS_DECL_MOZISPELLI18NUTIL \
  ...
  NS_IMETHOD GetRootForm(const char16_t * word, uint32_t type, char16_t * **words, uint32_t *count); \
  NS_IMETHOD FromRootForm(const char16_t * word, const char16_t * *iwords, uint32_t icount, char16_t * **owords, uint32_t *ocount); \
  NS_IMETHOD FindNextWord(const char16_t * word, uint32_t length, uint32_t offset, int32_t *begin, int32_t *end); 
...
#define NS_FORWARD_MOZISPELLI18NUTIL(_to) \
  ...
  NS_IMETHOD GetRootForm(const char16_t * word, uint32_t type, char16_t * **words, uint32_t *count) { return _to GetRootForm(word, type, words, count); } \
  NS_IMETHOD FromRootForm(const char16_t * word, const char16_t * *iwords, uint32_t icount, char16_t * **owords, uint32_t *ocount) { return _to FromRootForm(word, iwords, icount, owords, ocount); } \
  NS_IMETHOD FindNextWord(const char16_t * word, uint32_t length, uint32_t offset, int32_t *begin, int32_t *end) { return _to FindNextWord(word, length, offset, begin, end); } 
...
#define NS_FORWARD_SAFE_MOZISPELLI18NUTIL(_to) \
  ...
  NS_IMETHOD GetRootForm(const char16_t * word, uint32_t type, char16_t * **words, uint32_t *count) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRootForm(word, type, words, count); } \
  NS_IMETHOD FromRootForm(const char16_t * word, const char16_t * *iwords, uint32_t icount, char16_t * **owords, uint32_t *ocount) { return !_to ? NS_ERROR_NULL_POINTER : _to->FromRootForm(word, iwords, icount, owords, ocount); } \
  NS_IMETHOD FindNextWord(const char16_t * word, uint32_t length, uint32_t offset, int32_t *begin, int32_t *end) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindNextWord(word, length, offset, begin, end); } 
