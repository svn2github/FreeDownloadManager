...
#define NS_DECL_NSITOOLKITPROFILESERVICE \
  ...
  NS_IMETHOD CreateProfile(nsIFile *aRootDir, const nsACString & aName, nsIToolkitProfile * *_retval); \
...
#define NS_FORWARD_NSITOOLKITPROFILESERVICE(_to) \
  ...
  NS_IMETHOD CreateProfile(nsIFile *aRootDir, const nsACString & aName, nsIToolkitProfile * *_retval) { return _to CreateProfile(aRootDir, aName, _retval); } \
...
#define NS_FORWARD_SAFE_NSITOOLKITPROFILESERVICE(_to) \
  ...
  NS_IMETHOD CreateProfile(nsIFile *aRootDir, const nsACString & aName, nsIToolkitProfile * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateProfile(aRootDir, aName, _retval); } \
