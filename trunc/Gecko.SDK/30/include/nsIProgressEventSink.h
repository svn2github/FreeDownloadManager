...
#define NS_DECL_NSIPROGRESSEVENTSINK \
  ...
  NS_IMETHOD OnStatus(nsIRequest *aRequest, nsISupports *aContext, nsresult aStatus, const char16_t * aStatusArg); 
...
#define NS_FORWARD_NSIPROGRESSEVENTSINK(_to) \
  ...
  NS_IMETHOD OnStatus(nsIRequest *aRequest, nsISupports *aContext, nsresult aStatus, const char16_t * aStatusArg) { return _to OnStatus(aRequest, aContext, aStatus, aStatusArg); } 
...
#define NS_FORWARD_SAFE_NSIPROGRESSEVENTSINK(_to) \
  ...
  NS_IMETHOD OnStatus(nsIRequest *aRequest, nsISupports *aContext, nsresult aStatus, const char16_t * aStatusArg) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStatus(aRequest, aContext, aStatus, aStatusArg); } 
