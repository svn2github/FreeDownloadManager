...
#define NS_DECL_NSIPKCS11MODULEDB \
  ...
  NS_IMETHOD FindModuleByName(const char16_t * name, nsIPKCS11Module * *_retval); \
...
#define NS_FORWARD_NSIPKCS11MODULEDB(_to) \
  ...
  NS_IMETHOD FindModuleByName(const char16_t * name, nsIPKCS11Module * *_retval) { return _to FindModuleByName(name, _retval); } \
...
#define NS_FORWARD_SAFE_NSIPKCS11MODULEDB(_to) \
  ...
  NS_IMETHOD FindModuleByName(const char16_t * name, nsIPKCS11Module * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindModuleByName(name, _retval); } \
