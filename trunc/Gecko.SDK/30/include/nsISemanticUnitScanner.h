...
#define NS_DECL_NSISEMANTICUNITSCANNER \
  ...
  NS_IMETHOD Next(const char16_t * text, int32_t length, int32_t pos, bool isLastBuffer, int32_t *begin, int32_t *end, bool *_retval); 
...
#define NS_FORWARD_NSISEMANTICUNITSCANNER(_to) \
  ...
  NS_IMETHOD Next(const char16_t * text, int32_t length, int32_t pos, bool isLastBuffer, int32_t *begin, int32_t *end, bool *_retval) { return _to Next(text, length, pos, isLastBuffer, begin, end, _retval); } 
...
#define NS_FORWARD_SAFE_NSISEMANTICUNITSCANNER(_to) \
  ...
  NS_IMETHOD Next(const char16_t * text, int32_t length, int32_t pos, bool isLastBuffer, int32_t *begin, int32_t *end, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Next(text, length, pos, isLastBuffer, begin, end, _retval); } 
