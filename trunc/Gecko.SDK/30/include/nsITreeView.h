...
#define NS_DECL_NSITREEVIEW \
  ...
  NS_IMETHOD PerformAction(const char16_t * action); \
  NS_IMETHOD PerformActionOnRow(const char16_t * action, int32_t row); \
  NS_IMETHOD PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col); 
...
#define NS_FORWARD_NSITREEVIEW(_to) \
  ...
  NS_IMETHOD PerformAction(const char16_t * action) { return _to PerformAction(action); } \
  NS_IMETHOD PerformActionOnRow(const char16_t * action, int32_t row) { return _to PerformActionOnRow(action, row); } \
  NS_IMETHOD PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col) { return _to PerformActionOnCell(action, row, col); } 
...
#define NS_FORWARD_SAFE_NSITREEVIEW(_to) \
  ...
  NS_IMETHOD PerformAction(const char16_t * action) { return !_to ? NS_ERROR_NULL_POINTER : _to->PerformAction(action); } \
  NS_IMETHOD PerformActionOnRow(const char16_t * action, int32_t row) { return !_to ? NS_ERROR_NULL_POINTER : _to->PerformActionOnRow(action, row); } \
  NS_IMETHOD PerformActionOnCell(const char16_t * action, int32_t row, nsITreeColumn *col) { return !_to ? NS_ERROR_NULL_POINTER : _to->PerformActionOnCell(action, row, col); } 
