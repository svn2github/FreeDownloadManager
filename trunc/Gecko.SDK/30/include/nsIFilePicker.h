...
#define NS_IFILEPICKER_IID_STR "f93509a0-0434-11e3-8ffd-0800200c9a66"

#define NS_IFILEPICKER_IID \
  {0xf93509a0, 0x0434, 0x11e3, \
    { 0x8f, 0xfd, 0x08, 0x00, 0x20, 0x0c, 0x9a, 0x66 }}
...
#define NS_FORWARD_NSIFILEPICKER(_to) \
  ...
  NS_IMETHOD GetMode(int16_t *aMode) { return _to GetMode(aMode); } 
...
#define NS_FORWARD_SAFE_NSIFILEPICKER(_to) \
  ...
  NS_IMETHOD GetMode(int16_t *aMode) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMode(aMode); } 
