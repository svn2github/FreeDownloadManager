...
#define NS_IAPPSHELLSERVICE_IID_STR "2fa2f813-c216-4efb-8a8c-de60108ce5e5"

#define NS_IAPPSHELLSERVICE_IID \
  {0x2fa2f813, 0xc216, 0x4efb, \
    { 0x8a, 0x8c, 0xde, 0x60, 0x10, 0x8c, 0xe5, 0xe5 }}
...
#define NS_DECL_NSIAPPSHELLSERVICE \
  ...
  NS_IMETHOD CreateWindowlessBrowser(bool aIsChrome, nsIWebNavigation * *_retval); \
  ...
  NS_IMETHOD StartEventLoopLagTracking(bool *_retval); \
  NS_IMETHOD StopEventLoopLagTracking(void); 
...
#define NS_FORWARD_NSIAPPSHELLSERVICE(_to) \
  ...
  NS_IMETHOD CreateWindowlessBrowser(bool aIsChrome, nsIWebNavigation * *_retval) { return _to CreateWindowlessBrowser(aIsChrome, _retval); } \
  ...
  NS_IMETHOD StartEventLoopLagTracking(bool *_retval) { return _to StartEventLoopLagTracking(_retval); } \
  NS_IMETHOD StopEventLoopLagTracking(void) { return _to StopEventLoopLagTracking(); } 
...
#define NS_FORWARD_SAFE_NSIAPPSHELLSERVICE(_to) \
  ...
  NS_IMETHOD CreateWindowlessBrowser(bool aIsChrome, nsIWebNavigation * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateWindowlessBrowser(aIsChrome, _retval); } \
  ...
  NS_IMETHOD StartEventLoopLagTracking(bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartEventLoopLagTracking(_retval); } \
  NS_IMETHOD StopEventLoopLagTracking(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->StopEventLoopLagTracking(); } 
