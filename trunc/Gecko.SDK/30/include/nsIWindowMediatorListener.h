...
#define NS_DECL_NSIWINDOWMEDIATORLISTENER \
  NS_IMETHOD OnWindowTitleChange(nsIXULWindow *window, const char16_t * newTitle); \
...
#define NS_FORWARD_NSIWINDOWMEDIATORLISTENER(_to) \
  NS_IMETHOD OnWindowTitleChange(nsIXULWindow *window, const char16_t * newTitle) { return _to OnWindowTitleChange(window, newTitle); } \
...
#define NS_FORWARD_SAFE_NSIWINDOWMEDIATORLISTENER(_to) \
  NS_IMETHOD OnWindowTitleChange(nsIXULWindow *window, const char16_t * newTitle) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnWindowTitleChange(window, newTitle); } \
