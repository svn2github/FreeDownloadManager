...
#define NS_DECL_MOZISPELLCHECKINGENGINE \
  NS_IMETHOD GetDictionary(char16_t * *aDictionary); \
  NS_IMETHOD SetDictionary(const char16_t * aDictionary); \
  NS_IMETHOD GetLanguage(char16_t * *aLanguage); \
  ...
  NS_IMETHOD GetCopyright(char16_t * *aCopyright); \
  ...
  NS_IMETHOD GetDictionaryList(char16_t * **dictionaries, uint32_t *count); \
  NS_IMETHOD Check(const char16_t * word, bool *_retval); \
  NS_IMETHOD Suggest(const char16_t * word, char16_t * **suggestions, uint32_t *count); \
...
#define NS_FORWARD_MOZISPELLCHECKINGENGINE(_to) \
  NS_IMETHOD GetDictionary(char16_t * *aDictionary) { return _to GetDictionary(aDictionary); } \
  NS_IMETHOD SetDictionary(const char16_t * aDictionary) { return _to SetDictionary(aDictionary); } \
  NS_IMETHOD GetLanguage(char16_t * *aLanguage) { return _to GetLanguage(aLanguage); } \
  ...
  NS_IMETHOD GetCopyright(char16_t * *aCopyright) { return _to GetCopyright(aCopyright); } \
  ...
  NS_IMETHOD GetDictionaryList(char16_t * **dictionaries, uint32_t *count) { return _to GetDictionaryList(dictionaries, count); } \
  NS_IMETHOD Check(const char16_t * word, bool *_retval) { return _to Check(word, _retval); } \
  NS_IMETHOD Suggest(const char16_t * word, char16_t * **suggestions, uint32_t *count) { return _to Suggest(word, suggestions, count); } \
...
#define NS_FORWARD_SAFE_MOZISPELLCHECKINGENGINE(_to) \
  NS_IMETHOD GetDictionary(char16_t * *aDictionary) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDictionary(aDictionary); } \
  NS_IMETHOD SetDictionary(const char16_t * aDictionary) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDictionary(aDictionary); } \
  NS_IMETHOD GetLanguage(char16_t * *aLanguage) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLanguage(aLanguage); } \
  ...
  NS_IMETHOD GetCopyright(char16_t * *aCopyright) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCopyright(aCopyright); } \
  ...
  NS_IMETHOD GetDictionaryList(char16_t * **dictionaries, uint32_t *count) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDictionaryList(dictionaries, count); } \
  NS_IMETHOD Check(const char16_t * word, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Check(word, _retval); } \
  NS_IMETHOD Suggest(const char16_t * word, char16_t * **suggestions, uint32_t *count) { return !_to ? NS_ERROR_NULL_POINTER : _to->Suggest(word, suggestions, count); } \
