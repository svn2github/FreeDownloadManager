...
#define NS_DECL_NSITOKENDIALOGS \
  NS_IMETHOD ChooseToken(nsIInterfaceRequestor *ctx, const char16_t * *tokenNameList, uint32_t count, char16_t * *tokenName, bool *canceled); \
...
#define NS_FORWARD_NSITOKENDIALOGS(_to) \
  NS_IMETHOD ChooseToken(nsIInterfaceRequestor *ctx, const char16_t * *tokenNameList, uint32_t count, char16_t * *tokenName, bool *canceled) { return _to ChooseToken(ctx, tokenNameList, count, tokenName, canceled); } \
...
#define NS_FORWARD_SAFE_NSITOKENDIALOGS(_to) \
  NS_IMETHOD ChooseToken(nsIInterfaceRequestor *ctx, const char16_t * *tokenNameList, uint32_t count, char16_t * *tokenName, bool *canceled) { return !_to ? NS_ERROR_NULL_POINTER : _to->ChooseToken(ctx, tokenNameList, count, tokenName, canceled); } \
