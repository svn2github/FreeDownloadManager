...
#define NS_IHTTPCHANNELINTERNAL_IID_STR "b733194f-6751-4876-a444-bca4ba3f2fcb"

#define NS_IHTTPCHANNELINTERNAL_IID \
  {0xb733194f, 0x6751, 0x4876, \
    { 0xa4, 0x44, 0xbc, 0xa4, 0xba, 0x3f, 0x2f, 0xcb }}
...
#define NS_DECL_NSIHTTPCHANNELINTERNAL \
  ...
  NS_IMETHOD GetResponseTimeoutEnabled(bool *aResponseTimeoutEnabled); \
  NS_IMETHOD SetResponseTimeoutEnabled(bool aResponseTimeoutEnabled); \
...
#define NS_FORWARD_NSIHTTPCHANNELINTERNAL(_to) \
  ...
  NS_IMETHOD GetResponseTimeoutEnabled(bool *aResponseTimeoutEnabled) { return _to GetResponseTimeoutEnabled(aResponseTimeoutEnabled); } \
  NS_IMETHOD SetResponseTimeoutEnabled(bool aResponseTimeoutEnabled) { return _to SetResponseTimeoutEnabled(aResponseTimeoutEnabled); } \
  NS_IMETHOD GetApiRedirectToURI(nsIURI * *aApiRedirectToURI) { return _to GetApiRedirectToURI(aApiRedirectToURI); } 
...
#define NS_FORWARD_SAFE_NSIHTTPCHANNELINTERNAL(_to) \
  ...
  NS_IMETHOD GetResponseTimeoutEnabled(bool *aResponseTimeoutEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResponseTimeoutEnabled(aResponseTimeoutEnabled); } \
  NS_IMETHOD SetResponseTimeoutEnabled(bool aResponseTimeoutEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetResponseTimeoutEnabled(aResponseTimeoutEnabled); } \
  NS_IMETHOD GetApiRedirectToURI(nsIURI * *aApiRedirectToURI) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetApiRedirectToURI(aApiRedirectToURI); } 
