...
#define NS_IOBJECTLOADINGCONTENT_IID_STR "16c14177-52eb-49d3-9842-a1a0b92be11a"

#define NS_IOBJECTLOADINGCONTENT_IID \
  {0x16c14177, 0x52eb, 0x49d3, \
    { 0x98, 0x42, 0xa1, 0xa0, 0xb9, 0x2b, 0xe1, 0x1a }}
...
#define NS_DECL_NSIOBJECTLOADINGCONTENT \
  ...
  NS_IMETHOD Reload(bool aClearActivation); \
...
#define NS_FORWARD_NSIOBJECTLOADINGCONTENT(_to) \
  ...
  NS_IMETHOD Reload(bool aClearActivation) { return _to Reload(aClearActivation); } \
...
#define NS_FORWARD_SAFE_NSIOBJECTLOADINGCONTENT(_to) \
  ...
  NS_IMETHOD Reload(bool aClearActivation) { return !_to ? NS_ERROR_NULL_POINTER : _to->Reload(aClearActivation); } \
