/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl\nsIDOMNotifyAudioAvailableEvent.idl
 */
...
class NS_NO_VTABLE nsIDOMNotifyAudioAvailableEvent : public nsIDOMEvent {
 public: 
  ...
  NS_IMETHOD GetFrameBuffer(JSContext* cx, JS::MutableHandleValue aFrameBuffer) = 0;
...
#define NS_DECL_NSIDOMNOTIFYAUDIOAVAILABLEEVENT \
  NS_IMETHOD GetFrameBuffer(JSContext* cx, JS::MutableHandleValue aFrameBuffer); \
...
#define NS_FORWARD_NSIDOMNOTIFYAUDIOAVAILABLEEVENT(_to) \
  NS_IMETHOD GetFrameBuffer(JSContext* cx, JS::MutableHandleValue aFrameBuffer) { return _to GetFrameBuffer(cx, aFrameBuffer); } \
...
#define NS_FORWARD_SAFE_NSIDOMNOTIFYAUDIOAVAILABLEEVENT(_to) \
  NS_IMETHOD GetFrameBuffer(JSContext* cx, JS::MutableHandleValue aFrameBuffer) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFrameBuffer(cx, aFrameBuffer); } \
...
/* [implicit_jscontext] readonly attribute jsval frameBuffer; */
NS_IMETHODIMP nsDOMNotifyAudioAvailableEvent::GetFrameBuffer(JSContext* cx, JS::MutableHandleValue aFrameBuffer)
{
