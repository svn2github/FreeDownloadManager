...
#define NS_DECL_NETDASHBOARDCALLBACK \
  NS_IMETHOD OnDashboardDataAvailable(JS::HandleValue data); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NETDASHBOARDCALLBACK(_to) \
  NS_IMETHOD OnDashboardDataAvailable(JS::HandleValue data) { return _to OnDashboardDataAvailable(data); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NETDASHBOARDCALLBACK(_to) \
  NS_IMETHOD OnDashboardDataAvailable(JS::HandleValue data) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnDashboardDataAvailable(data); } 
