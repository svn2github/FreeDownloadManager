...
#define NS_DECL_MOZIPERSONALDICTIONARY \
  ...
  NS_IMETHOD Check(const char16_t * word, const char16_t * lang, bool *_retval); \
  NS_IMETHOD AddWord(const char16_t * word, const char16_t * lang); \
  NS_IMETHOD RemoveWord(const char16_t * word, const char16_t * lang); \
  NS_IMETHOD IgnoreWord(const char16_t * word); \
  NS_IMETHOD EndSession(void); \
  NS_IMETHOD AddCorrection(const char16_t * word, const char16_t * correction, const char16_t * lang); \
  NS_IMETHOD RemoveCorrection(const char16_t * word, const char16_t * correction, const char16_t * lang); \
  NS_IMETHOD GetCorrection(const char16_t * word, char16_t * **words, uint32_t *count); 
...
#define NS_FORWARD_MOZIPERSONALDICTIONARY(_to) \
  ...
  NS_IMETHOD Check(const char16_t * word, const char16_t * lang, bool *_retval) { return _to Check(word, lang, _retval); } \
  NS_IMETHOD AddWord(const char16_t * word, const char16_t * lang) { return _to AddWord(word, lang); } \
  NS_IMETHOD RemoveWord(const char16_t * word, const char16_t * lang) { return _to RemoveWord(word, lang); } \
  NS_IMETHOD IgnoreWord(const char16_t * word) { return _to IgnoreWord(word); } \
  NS_IMETHOD EndSession(void) { return _to EndSession(); } \
  NS_IMETHOD AddCorrection(const char16_t * word, const char16_t * correction, const char16_t * lang) { return _to AddCorrection(word, correction, lang); } \
  NS_IMETHOD RemoveCorrection(const char16_t * word, const char16_t * correction, const char16_t * lang) { return _to RemoveCorrection(word, correction, lang); } \
  NS_IMETHOD GetCorrection(const char16_t * word, char16_t * **words, uint32_t *count) { return _to GetCorrection(word, words, count); } 
...
#define NS_FORWARD_SAFE_MOZIPERSONALDICTIONARY(_to) \
  ...
  NS_IMETHOD Check(const char16_t * word, const char16_t * lang, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Check(word, lang, _retval); } \
  NS_IMETHOD AddWord(const char16_t * word, const char16_t * lang) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddWord(word, lang); } \
  NS_IMETHOD RemoveWord(const char16_t * word, const char16_t * lang) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveWord(word, lang); } \
  NS_IMETHOD IgnoreWord(const char16_t * word) { return !_to ? NS_ERROR_NULL_POINTER : _to->IgnoreWord(word); } \
  NS_IMETHOD EndSession(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->EndSession(); } \
  NS_IMETHOD AddCorrection(const char16_t * word, const char16_t * correction, const char16_t * lang) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddCorrection(word, correction, lang); } \
  NS_IMETHOD RemoveCorrection(const char16_t * word, const char16_t * correction, const char16_t * lang) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveCorrection(word, correction, lang); } \
  NS_IMETHOD GetCorrection(const char16_t * word, char16_t * **words, uint32_t *count) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCorrection(word, words, count); } 
