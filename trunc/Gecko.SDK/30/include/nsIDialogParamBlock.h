...
#define NS_DECL_NSIDIALOGPARAMBLOCK \
  ...
  NS_IMETHOD GetString(int32_t inIndex, char16_t * *_retval); \
  NS_IMETHOD SetString(int32_t inIndex, const char16_t * inString); \
...
#define NS_FORWARD_NSIDIALOGPARAMBLOCK(_to) \
  ...
  NS_IMETHOD GetString(int32_t inIndex, char16_t * *_retval) { return _to GetString(inIndex, _retval); } \
  NS_IMETHOD SetString(int32_t inIndex, const char16_t * inString) { return _to SetString(inIndex, inString); } \
...
#define NS_FORWARD_SAFE_NSIDIALOGPARAMBLOCK(_to) \
  ...
  NS_IMETHOD GetString(int32_t inIndex, char16_t * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetString(inIndex, _retval); } \
  NS_IMETHOD SetString(int32_t inIndex, const char16_t * inString) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetString(inIndex, inString); } \
