...
class NS_NO_VTABLE nsICertOverrideService : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetAllOverrideHostsWithPorts(uint32_t *aCount, char16_t * **aHostsWithPortsArray) = 0;
...
#define NS_DECL_NSICERTOVERRIDESERVICE \
  ...
  NS_IMETHOD GetAllOverrideHostsWithPorts(uint32_t *aCount, char16_t * **aHostsWithPortsArray); \
...
#define NS_FORWARD_NSICERTOVERRIDESERVICE(_to) \
  ...
  NS_IMETHOD GetAllOverrideHostsWithPorts(uint32_t *aCount, char16_t * **aHostsWithPortsArray) { return _to GetAllOverrideHostsWithPorts(aCount, aHostsWithPortsArray); } \
...
#define NS_FORWARD_SAFE_NSICERTOVERRIDESERVICE(_to) \
  ...
  NS_IMETHOD GetAllOverrideHostsWithPorts(uint32_t *aCount, char16_t * **aHostsWithPortsArray) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllOverrideHostsWithPorts(aCount, aHostsWithPortsArray); } \
...
/* void getAllOverrideHostsWithPorts (out uint32_t aCount, [array, size_is (aCount)] out wstring aHostsWithPortsArray); */
NS_IMETHODIMP nsCertOverrideService::GetAllOverrideHostsWithPorts(uint32_t *aCount, char16_t * **aHostsWithPortsArray)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
