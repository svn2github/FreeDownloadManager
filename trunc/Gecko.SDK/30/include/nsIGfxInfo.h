...
#define NS_DECL_NSIGFXINFO \
  ...
  NS_IMETHOD GetInfo(JSContext* cx, JS::MutableHandleValue _retval); 
...
#define NS_FORWARD_NSIGFXINFO(_to) \
  ...
  NS_IMETHOD GetInfo(JSContext* cx, JS::MutableHandleValue _retval) { return _to GetInfo(cx, _retval); } 
...
#define NS_FORWARD_SAFE_NSIGFXINFO(_to) \
  ...
  NS_IMETHOD_(void) GetData(void); \
  NS_IMETHOD GetInfo(JSContext* cx, JS::MutableHandleValue _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInfo(cx, _retval); } 
