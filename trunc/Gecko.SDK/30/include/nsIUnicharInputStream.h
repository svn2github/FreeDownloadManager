...
#define NS_DECL_NSIUNICHARINPUTSTREAM \
  NS_IMETHOD Read(char16_t *aBuf, uint32_t aCount, uint32_t *_retval); \
...
#define NS_FORWARD_NSIUNICHARINPUTSTREAM(_to) \
  NS_IMETHOD Read(char16_t *aBuf, uint32_t aCount, uint32_t *_retval) { return _to Read(aBuf, aCount, _retval); } \
...
#define NS_FORWARD_SAFE_NSIUNICHARINPUTSTREAM(_to) \
  NS_IMETHOD Read(char16_t *aBuf, uint32_t aCount, uint32_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Read(aBuf, aCount, _retval); } \
