...
#define NS_DECL_NSIDOMMOUSEEVENT \
  ...
  NS_IMETHOD GetButton(int16_t *aButton); \
...
#define NS_FORWARD_NSIDOMMOUSEEVENT(_to) \
  ...
  NS_IMETHOD GetButton(int16_t *aButton) { return _to GetButton(aButton); } \
...
#define NS_FORWARD_SAFE_NSIDOMMOUSEEVENT(_to) \
  ...
  NS_IMETHOD GetButton(int16_t *aButton) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetButton(aButton); } \
