...
#define NS_DECL_NSIINLINESPELLCHECKER \
  ...
  NS_IMETHOD IgnoreWords(const char16_t * *aWordsToIgnore, uint32_t aCount); \
...
#define NS_FORWARD_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_IMETHOD IgnoreWords(const char16_t * *aWordsToIgnore, uint32_t aCount) { return _to IgnoreWords(aWordsToIgnore, aCount); } \
...
#define NS_FORWARD_SAFE_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_IMETHOD IgnoreWords(const char16_t * *aWordsToIgnore, uint32_t aCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->IgnoreWords(aWordsToIgnore, aCount); } \
