...
#define NS_DECL_NSIDOMDATATRANSFER \
  ...
  NS_IMETHOD GetTypes(nsISupports * *aTypes); \
  ...
  NS_IMETHOD MozTypesAt(uint32_t index, nsISupports * *_retval); \
...
#define NS_FORWARD_NSIDOMDATATRANSFER(_to) \
  ...
  NS_IMETHOD GetTypes(nsISupports * *aTypes) { return _to GetTypes(aTypes); } \
  ...
  NS_IMETHOD MozTypesAt(uint32_t index, nsISupports * *_retval) { return _to MozTypesAt(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMDATATRANSFER(_to) \
  ...
  NS_IMETHOD GetTypes(nsISupports * *aTypes) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTypes(aTypes); } \
  ...
  NS_IMETHOD MozTypesAt(uint32_t index, nsISupports * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozTypesAt(index, _retval); } \
