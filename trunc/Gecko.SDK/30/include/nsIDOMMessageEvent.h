...
#define NS_DECL_NSIDOMMESSAGEEVENT \
  NS_IMETHOD GetData(JSContext* cx, JS::MutableHandleValue aData); \
  ...
  NS_IMETHOD InitMessageEvent(const nsAString & aType, bool aCanBubble, bool aCancelable, JS::HandleValue aData, const nsAString & aOrigin, const nsAString & aLastEventId, nsIDOMWindow *aSource); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMMESSAGEEVENT(_to) \
  NS_IMETHOD GetData(JSContext* cx, JS::MutableHandleValue aData) { return _to GetData(cx, aData); } \
  ...
  NS_IMETHOD InitMessageEvent(const nsAString & aType, bool aCanBubble, bool aCancelable, JS::HandleValue aData, const nsAString & aOrigin, const nsAString & aLastEventId, nsIDOMWindow *aSource) { return _to InitMessageEvent(aType, aCanBubble, aCancelable, aData, aOrigin, aLastEventId, aSource); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMMESSAGEEVENT(_to) \
  NS_IMETHOD GetData(JSContext* cx, JS::MutableHandleValue aData) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetData(cx, aData); } \
  ...
  NS_IMETHOD InitMessageEvent(const nsAString & aType, bool aCanBubble, bool aCancelable, JS::HandleValue aData, const nsAString & aOrigin, const nsAString & aLastEventId, nsIDOMWindow *aSource) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitMessageEvent(aType, aCanBubble, aCancelable, aData, aOrigin, aLastEventId, aSource); } 
