...
#define MOZIDOMAPPLICATION_IID_STR "f8cb08ed-588e-465f-b2b3-a4b0afde711a"

#define MOZIDOMAPPLICATION_IID \
  {0xf8cb08ed, 0x588e, 0x465f, \
    { 0xb2, 0xb3, 0xa4, 0xb0, 0xaf, 0xde, 0x71, 0x1a }}
...
class NS_NO_VTABLE mozIDOMApplication : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetManifest(JS::MutableHandleValue aManifest) = 0;

  /* readonly attribute jsval updateManifest; */
  NS_IMETHOD GetUpdateManifest(JS::MutableHandleValue aUpdateManifest) = 0;

  /* readonly attribute DOMString manifestURL; */
  NS_IMETHOD GetManifestURL(nsAString & aManifestURL) = 0;

  /* readonly attribute jsval receipts; */
  NS_IMETHOD GetReceipts(JS::MutableHandleValue aReceipts) = 0;
  ...
  NS_IMETHOD Connect(const nsAString & keyword, JS::HandleValue rules, nsISupports * *_retval) = 0;

  /* nsISupports getConnections (); */
  NS_IMETHOD GetConnections(nsISupports * *_retval) = 0;

  /* nsIDOMDOMRequest addReceipt (in DOMString receipt); */
  NS_IMETHOD AddReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval) = 0;

  /* nsIDOMDOMRequest removeReceipt (in DOMString receipt); */
  NS_IMETHOD RemoveReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval) = 0;

  /* nsIDOMDOMRequest replaceReceipt (in DOMString oldReceipt, in DOMString newReceipt); */
  NS_IMETHOD ReplaceReceipt(const nsAString & oldReceipt, const nsAString & newReceipt, nsIDOMDOMRequest * *_retval) = 0;
...
#define NS_DECL_MOZIDOMAPPLICATION \
  NS_IMETHOD GetManifest(JS::MutableHandleValue aManifest); \
  NS_IMETHOD GetUpdateManifest(JS::MutableHandleValue aUpdateManifest); \
  NS_IMETHOD GetManifestURL(nsAString & aManifestURL); \
  NS_IMETHOD GetReceipts(JS::MutableHandleValue aReceipts); \
  ...
  NS_IMETHOD Connect(const nsAString & keyword, JS::HandleValue rules, nsISupports * *_retval); \
  NS_IMETHOD GetConnections(nsISupports * *_retval); \
  NS_IMETHOD AddReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval); \
  NS_IMETHOD RemoveReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval); \
  NS_IMETHOD ReplaceReceipt(const nsAString & oldReceipt, const nsAString & newReceipt, nsIDOMDOMRequest * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZIDOMAPPLICATION(_to) \
  NS_IMETHOD GetManifest(JS::MutableHandleValue aManifest) { return _to GetManifest(aManifest); } \
  NS_IMETHOD GetUpdateManifest(JS::MutableHandleValue aUpdateManifest) { return _to GetUpdateManifest(aUpdateManifest); } \
  NS_IMETHOD GetManifestURL(nsAString & aManifestURL) { return _to GetManifestURL(aManifestURL); } \
  NS_IMETHOD GetReceipts(JS::MutableHandleValue aReceipts) { return _to GetReceipts(aReceipts); } \
  ...
  NS_IMETHOD Connect(const nsAString & keyword, JS::HandleValue rules, nsISupports * *_retval) { return _to Connect(keyword, rules, _retval); } \
  NS_IMETHOD GetConnections(nsISupports * *_retval) { return _to GetConnections(_retval); } \
  NS_IMETHOD AddReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval) { return _to AddReceipt(receipt, _retval); } \
  NS_IMETHOD RemoveReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval) { return _to RemoveReceipt(receipt, _retval); } \
  NS_IMETHOD ReplaceReceipt(const nsAString & oldReceipt, const nsAString & newReceipt, nsIDOMDOMRequest * *_retval) { return _to ReplaceReceipt(oldReceipt, newReceipt, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZIDOMAPPLICATION(_to) \
  NS_IMETHOD GetManifest(JS::MutableHandleValue aManifest) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetManifest(aManifest); } \
  NS_IMETHOD GetUpdateManifest(JS::MutableHandleValue aUpdateManifest) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUpdateManifest(aUpdateManifest); } \
  NS_IMETHOD GetManifestURL(nsAString & aManifestURL) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetManifestURL(aManifestURL); } \
  NS_IMETHOD GetReceipts(JS::MutableHandleValue aReceipts) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetReceipts(aReceipts); } \
  ...
  NS_IMETHOD Connect(const nsAString & keyword, JS::HandleValue rules, nsISupports * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Connect(keyword, rules, _retval); } \
  NS_IMETHOD GetConnections(nsISupports * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetConnections(_retval); } \
  NS_IMETHOD AddReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddReceipt(receipt, _retval); } \
  NS_IMETHOD RemoveReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveReceipt(receipt, _retval); } \
  NS_IMETHOD ReplaceReceipt(const nsAString & oldReceipt, const nsAString & newReceipt, nsIDOMDOMRequest * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReplaceReceipt(oldReceipt, newReceipt, _retval); } 
...
/* readonly attribute jsval manifest; */
NS_IMETHODIMP _MYCLASS_::GetManifest(JS::MutableHandleValue aManifest)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute jsval updateManifest; */
NS_IMETHODIMP _MYCLASS_::GetUpdateManifest(JS::MutableHandleValue aUpdateManifest)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute jsval receipts; */
NS_IMETHODIMP _MYCLASS_::GetReceipts(JS::MutableHandleValue aReceipts)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsISupports connect (in DOMString keyword, [optional] in jsval rules); */
NS_IMETHODIMP _MYCLASS_::Connect(const nsAString & keyword, JS::HandleValue rules, nsISupports * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsISupports getConnections (); */
NS_IMETHODIMP _MYCLASS_::GetConnections(nsISupports * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMDOMRequest addReceipt (in DOMString receipt); */
NS_IMETHODIMP _MYCLASS_::AddReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMDOMRequest removeReceipt (in DOMString receipt); */
NS_IMETHODIMP _MYCLASS_::RemoveReceipt(const nsAString & receipt, nsIDOMDOMRequest * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMDOMRequest replaceReceipt (in DOMString oldReceipt, in DOMString newReceipt); */
NS_IMETHODIMP _MYCLASS_::ReplaceReceipt(const nsAString & oldReceipt, const nsAString & newReceipt, nsIDOMDOMRequest * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE mozIDOMApplicationRegistry : public nsISupports {
 public: 
  ...
  NS_IMETHOD Install(const nsAString & manifestUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval) = 0;
  ...
  NS_IMETHOD InstallPackage(const nsAString & packageUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval) = 0;
...
#define NS_DECL_MOZIDOMAPPLICATIONREGISTRY \
  NS_IMETHOD Install(const nsAString & manifestUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval); \
  ...
  NS_IMETHOD InstallPackage(const nsAString & packageUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval); \
  NS_IMETHOD GetMgmt(mozIDOMApplicationMgmt * *aMgmt); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZIDOMAPPLICATIONREGISTRY(_to) \
  NS_IMETHOD Install(const nsAString & manifestUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval) { return _to Install(manifestUrl, parameters, _retval); } \
  ...
  NS_IMETHOD InstallPackage(const nsAString & packageUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval) { return _to InstallPackage(packageUrl, parameters, _retval); } \
...
#define NS_FORWARD_SAFE_MOZIDOMAPPLICATIONREGISTRY(_to) \
  NS_IMETHOD Install(const nsAString & manifestUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Install(manifestUrl, parameters, _retval); } \
  ...
  NS_IMETHOD InstallPackage(const nsAString & packageUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InstallPackage(packageUrl, parameters, _retval); } \
...
/* nsIDOMDOMRequest install (in DOMString manifestUrl, [optional] in jsval parameters); */
NS_IMETHODIMP _MYCLASS_::Install(const nsAString & manifestUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIDOMDOMRequest installPackage (in DOMString packageUrl, [optional] in jsval parameters); */
NS_IMETHODIMP _MYCLASS_::InstallPackage(const nsAString & packageUrl, JS::HandleValue parameters, nsIDOMDOMRequest * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
