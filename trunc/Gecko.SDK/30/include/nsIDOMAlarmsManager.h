...
class NS_NO_VTABLE nsIDOMMozAlarmsManager : public nsISupports {
 public: 
  ...
  NS_IMETHOD Add(JS::HandleValue date, const nsAString & respectTimezone, JS::HandleValue data, nsIDOMDOMRequest * *_retval) = 0;
...
#define NS_DECL_NSIDOMMOZALARMSMANAGER \
  ...
  NS_IMETHOD Add(JS::HandleValue date, const nsAString & respectTimezone, JS::HandleValue data, nsIDOMDOMRequest * *_retval); \
...
#define NS_FORWARD_NSIDOMMOZALARMSMANAGER(_to) \
  ...
  NS_IMETHOD Add(JS::HandleValue date, const nsAString & respectTimezone, JS::HandleValue data, nsIDOMDOMRequest * *_retval) { return _to Add(date, respectTimezone, data, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMMOZALARMSMANAGER(_to) \
  ...
  NS_IMETHOD Add(JS::HandleValue date, const nsAString & respectTimezone, JS::HandleValue data, nsIDOMDOMRequest * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Add(date, respectTimezone, data, _retval); } \
...
/* nsIDOMDOMRequest add (in jsval date, in DOMString respectTimezone, [optional] in jsval data); */
NS_IMETHODIMP nsDOMMozAlarmsManager::Add(JS::HandleValue date, const nsAString & respectTimezone, JS::HandleValue data, nsIDOMDOMRequest * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
