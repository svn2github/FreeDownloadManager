...
#define NS_DECL_NSIJSCID \
  NS_IMETHOD CreateInstance(JS::HandleValue iid, JSContext* cx, uint8_t _argc, JS::MutableHandleValue _retval); \
  NS_IMETHOD GetService(JS::HandleValue iid, JSContext* cx, uint8_t _argc, JS::MutableHandleValue _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJSCID(_to) \
  NS_IMETHOD CreateInstance(JS::HandleValue iid, JSContext* cx, uint8_t _argc, JS::MutableHandleValue _retval) { return _to CreateInstance(iid, cx, _argc, _retval); } \
  NS_IMETHOD GetService(JS::HandleValue iid, JSContext* cx, uint8_t _argc, JS::MutableHandleValue _retval) { return _to GetService(iid, cx, _argc, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIJSCID(_to) \
  NS_IMETHOD CreateInstance(JS::HandleValue iid, JSContext* cx, uint8_t _argc, JS::MutableHandleValue _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateInstance(iid, cx, _argc, _retval); } \
  NS_IMETHOD GetService(JS::HandleValue iid, JSContext* cx, uint8_t _argc, JS::MutableHandleValue _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetService(iid, cx, _argc, _retval); } 
