...
#define NS_DECL_NSIDOMVALIDITYSTATE \
  ...
  NS_IMETHOD GetBadInput(bool *aBadInput); \
...
#define NS_FORWARD_NSIDOMVALIDITYSTATE(_to) \
  ...
  NS_IMETHOD GetBadInput(bool *aBadInput) { return _to GetBadInput(aBadInput); } \
...
#define NS_FORWARD_SAFE_NSIDOMVALIDITYSTATE(_to) \
  ...
  NS_IMETHOD GetBadInput(bool *aBadInput) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBadInput(aBadInput); } \
