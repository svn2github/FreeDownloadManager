...
#define NS_DECL_NSIPROCESS \
  ...
  NS_IMETHOD Runw(bool blocking, const char16_t * *args, uint32_t count); \
  NS_IMETHOD RunwAsync(const char16_t * *args, uint32_t count, nsIObserver *observer, bool holdWeak); \
...
#define NS_FORWARD_NSIPROCESS(_to) \
  ...
  NS_IMETHOD Runw(bool blocking, const char16_t * *args, uint32_t count) { return _to Runw(blocking, args, count); } \
  NS_IMETHOD RunwAsync(const char16_t * *args, uint32_t count, nsIObserver *observer, bool holdWeak) { return _to RunwAsync(args, count, observer, holdWeak); } \
...
#define NS_FORWARD_SAFE_NSIPROCESS(_to) \
  ...
  NS_IMETHOD Runw(bool blocking, const char16_t * *args, uint32_t count) { return !_to ? NS_ERROR_NULL_POINTER : _to->Runw(blocking, args, count); } \
  NS_IMETHOD RunwAsync(const char16_t * *args, uint32_t count, nsIObserver *observer, bool holdWeak) { return !_to ? NS_ERROR_NULL_POINTER : _to->RunwAsync(args, count, observer, holdWeak); } \
