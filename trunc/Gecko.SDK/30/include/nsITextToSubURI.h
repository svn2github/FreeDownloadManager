...
#define NS_DECL_NSITEXTTOSUBURI \
  NS_IMETHOD ConvertAndEscape(const char * charset, const char16_t * text, char * *_retval); \
  NS_IMETHOD UnEscapeAndConvert(const char * charset, const char * text, char16_t * *_retval); \
...
#define NS_FORWARD_NSITEXTTOSUBURI(_to) \
  NS_IMETHOD ConvertAndEscape(const char * charset, const char16_t * text, char * *_retval) { return _to ConvertAndEscape(charset, text, _retval); } \
  NS_IMETHOD UnEscapeAndConvert(const char * charset, const char * text, char16_t * *_retval) { return _to UnEscapeAndConvert(charset, text, _retval); } \
...
#define NS_FORWARD_SAFE_NSITEXTTOSUBURI(_to) \
  NS_IMETHOD ConvertAndEscape(const char * charset, const char16_t * text, char * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConvertAndEscape(charset, text, _retval); } \
  NS_IMETHOD UnEscapeAndConvert(const char * charset, const char * text, char16_t * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->UnEscapeAndConvert(charset, text, _retval); } \
