...
#define IMGICONTAINER_IID_STR "8b7db7dd-bfe9-40d3-9114-3a79c0658afd"

#define IMGICONTAINER_IID \
  {0x8b7db7dd, 0xbfe9, 0x40d3, \
    { 0x91, 0x14, 0x3a, 0x79, 0xc0, 0x65, 0x8a, 0xfd }}
...
class NS_NO_VTABLE imgIContainer : public nsISupports {
 public: 
  ...
  /* [noscript,notxpcom] already_AddRefed_gfxASurface getFrame (in uint32_t aWhichFrame, in uint32_t aFlags); */
  NS_IMETHOD_(already_AddRefed<gfxASurface>) GetFrame(uint32_t aWhichFrame, uint32_t aFlags) = 0;
  ...
  NS_IMETHOD Draw(gfxContext *aContext, GraphicsFilter aFilter, const gfxMatrix & aUserSpaceToImageSpace, const gfxRect & aFill, const nsIntRect & aSubimage, const nsIntSize & aViewportSize, const mozilla::SVGImageContext *aSVGContext, uint32_t aWhichFrame, uint32_t aFlags) = 0;
...
#define NS_DECL_IMGICONTAINER \
  ...
  NS_IMETHOD_(already_AddRefed<gfxASurface>) GetFrame(uint32_t aWhichFrame, uint32_t aFlags); \
  ...
  NS_IMETHOD Draw(gfxContext *aContext, GraphicsFilter aFilter, const gfxMatrix & aUserSpaceToImageSpace, const gfxRect & aFill, const nsIntRect & aSubimage, const nsIntSize & aViewportSize, const mozilla::SVGImageContext *aSVGContext, uint32_t aWhichFrame, uint32_t aFlags); \
  ...
  NS_IMETHOD_(mozilla::image::Orientation) GetOrientation(void); \
...
#define NS_FORWARD_IMGICONTAINER(_to) \
  ...
  NS_IMETHOD_(already_AddRefed<gfxASurface>) GetFrame(uint32_t aWhichFrame, uint32_t aFlags) { return _to GetFrame(aWhichFrame, aFlags); } \
  ...
  NS_IMETHOD_(mozilla::image::Orientation) GetOrientation(void) { return _to GetOrientation(); } \
...
/* [noscript,notxpcom] already_AddRefed_gfxASurface getFrame (in uint32_t aWhichFrame, in uint32_t aFlags); */
NS_IMETHODIMP_(already_AddRefed<gfxASurface>) _MYCLASS_::GetFrame(uint32_t aWhichFrame, uint32_t aFlags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript] void draw (in gfxContext aContext, in gfxGraphicsFilter aFilter, [const] in gfxMatrix aUserSpaceToImageSpace, [const] in gfxRect aFill, [const] in nsIntRect aSubimage, [const] in nsIntSize aViewportSize, [const] in SVGImageContext aSVGContext, in uint32_t aWhichFrame, in uint32_t aFlags); */
NS_IMETHODIMP _MYCLASS_::Draw(gfxContext *aContext, GraphicsFilter aFilter, const gfxMatrix & aUserSpaceToImageSpace, const gfxRect & aFill, const nsIntRect & aSubimage, const nsIntSize & aViewportSize, const mozilla::SVGImageContext *aSVGContext, uint32_t aWhichFrame, uint32_t aFlags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
