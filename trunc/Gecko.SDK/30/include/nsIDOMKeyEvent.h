...
#define NS_DECL_NSIDOMKEYEVENT \
  ...
  NS_IMETHOD GetRepeat(bool *aRepeat); \
...
#define NS_FORWARD_NSIDOMKEYEVENT(_to) \
  ...
  NS_IMETHOD GetRepeat(bool *aRepeat) { return _to GetRepeat(aRepeat); } \
...
#define NS_FORWARD_SAFE_NSIDOMKEYEVENT(_to) \
  ...
  NS_IMETHOD GetRepeat(bool *aRepeat) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRepeat(aRepeat); } \
