...
#define NS_DECL_NSIUSERINFO \
  NS_IMETHOD GetFullname(char16_t * *aFullname); \
...
#define NS_FORWARD_NSIUSERINFO(_to) \
  NS_IMETHOD GetFullname(char16_t * *aFullname) { return _to GetFullname(aFullname); } \
...
#define NS_FORWARD_SAFE_NSIUSERINFO(_to) \
  NS_IMETHOD GetFullname(char16_t * *aFullname) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFullname(aFullname); } \
