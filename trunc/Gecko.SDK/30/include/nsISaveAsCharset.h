...
#define NS_FORWARD_NSISAVEASCHARSET(_to) \
  ...
  NS_IMETHOD Convert(const char16_t * inString, char * *_retval) { return _to Convert(inString, _retval); } 
...
#define NS_FORWARD_SAFE_NSISAVEASCHARSET(_to) \
  ...
  NS_IMETHOD Convert(const char16_t * inString, char * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Convert(inString, _retval); } 
