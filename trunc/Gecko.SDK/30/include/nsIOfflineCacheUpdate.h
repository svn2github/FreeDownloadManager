...
#define NS_DECL_NSIOFFLINECACHEUPDATESERVICE \
  ...
  NS_IMETHOD ScheduleAppUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, uint32_t aAppID, bool aInBrowser, nsIFile *aProfileDir, nsIOfflineCacheUpdate * *_retval); \
  ...
  NS_IMETHOD AllowOfflineApp(nsIDOMWindow *aWindow, nsIPrincipal *aPrincipal); 
...
#define NS_FORWARD_NSIOFFLINECACHEUPDATESERVICE(_to) \
  ...
  NS_IMETHOD ScheduleAppUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, uint32_t aAppID, bool aInBrowser, nsIFile *aProfileDir, nsIOfflineCacheUpdate * *_retval) { return _to ScheduleAppUpdate(aManifestURI, aDocumentURI, aAppID, aInBrowser, aProfileDir, _retval); } \
  ...
  NS_IMETHOD AllowOfflineApp(nsIDOMWindow *aWindow, nsIPrincipal *aPrincipal) { return _to AllowOfflineApp(aWindow, aPrincipal); } 
...
#define NS_FORWARD_SAFE_NSIOFFLINECACHEUPDATESERVICE(_to) \
  ...
  NS_IMETHOD ScheduleAppUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, uint32_t aAppID, bool aInBrowser, nsIFile *aProfileDir, nsIOfflineCacheUpdate * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScheduleAppUpdate(aManifestURI, aDocumentURI, aAppID, aInBrowser, aProfileDir, _retval); } \
  ...
  NS_IMETHOD AllowOfflineApp(nsIDOMWindow *aWindow, nsIPrincipal *aPrincipal) { return !_to ? NS_ERROR_NULL_POINTER : _to->AllowOfflineApp(aWindow, aPrincipal); } 
