...
#define NS_DECL_NSIWINDOWMEDIATOR \
  NS_IMETHOD GetEnumerator(const char16_t * aWindowType, nsISimpleEnumerator * *_retval); \
  NS_IMETHOD GetXULWindowEnumerator(const char16_t * aWindowType, nsISimpleEnumerator * *_retval); \
  NS_IMETHOD GetZOrderDOMWindowEnumerator(const char16_t * aWindowType, bool aFrontToBack, nsISimpleEnumerator * *_retval); \
  NS_IMETHOD GetZOrderXULWindowEnumerator(const char16_t * aWindowType, bool aFrontToBack, nsISimpleEnumerator * *_retval); \
  NS_IMETHOD GetMostRecentWindow(const char16_t * aWindowType, nsIDOMWindow * *_retval); \
  ...
  NS_IMETHOD UpdateWindowTitle(nsIXULWindow *aWindow, const char16_t * inTitle); \
...
#define NS_FORWARD_NSIWINDOWMEDIATOR(_to) \
  NS_IMETHOD GetEnumerator(const char16_t * aWindowType, nsISimpleEnumerator * *_retval) { return _to GetEnumerator(aWindowType, _retval); } \
  NS_IMETHOD GetXULWindowEnumerator(const char16_t * aWindowType, nsISimpleEnumerator * *_retval) { return _to GetXULWindowEnumerator(aWindowType, _retval); } \
  NS_IMETHOD GetZOrderDOMWindowEnumerator(const char16_t * aWindowType, bool aFrontToBack, nsISimpleEnumerator * *_retval) { return _to GetZOrderDOMWindowEnumerator(aWindowType, aFrontToBack, _retval); } \
  NS_IMETHOD GetZOrderXULWindowEnumerator(const char16_t * aWindowType, bool aFrontToBack, nsISimpleEnumerator * *_retval) { return _to GetZOrderXULWindowEnumerator(aWindowType, aFrontToBack, _retval); } \
  NS_IMETHOD GetMostRecentWindow(const char16_t * aWindowType, nsIDOMWindow * *_retval) { return _to GetMostRecentWindow(aWindowType, _retval); } \
  ...
  NS_IMETHOD UpdateWindowTitle(nsIXULWindow *aWindow, const char16_t * inTitle) { return _to UpdateWindowTitle(aWindow, inTitle); } \
...
#define NS_FORWARD_SAFE_NSIWINDOWMEDIATOR(_to) \
  NS_IMETHOD GetEnumerator(const char16_t * aWindowType, nsISimpleEnumerator * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnumerator(aWindowType, _retval); } \
  NS_IMETHOD GetXULWindowEnumerator(const char16_t * aWindowType, nsISimpleEnumerator * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetXULWindowEnumerator(aWindowType, _retval); } \
  NS_IMETHOD GetZOrderDOMWindowEnumerator(const char16_t * aWindowType, bool aFrontToBack, nsISimpleEnumerator * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetZOrderDOMWindowEnumerator(aWindowType, aFrontToBack, _retval); } \
  NS_IMETHOD GetZOrderXULWindowEnumerator(const char16_t * aWindowType, bool aFrontToBack, nsISimpleEnumerator * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetZOrderXULWindowEnumerator(aWindowType, aFrontToBack, _retval); } \
  NS_IMETHOD GetMostRecentWindow(const char16_t * aWindowType, nsIDOMWindow * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMostRecentWindow(aWindowType, _retval); } \
  ...
  NS_IMETHOD UpdateWindowTitle(nsIXULWindow *aWindow, const char16_t * inTitle) { return !_to ? NS_ERROR_NULL_POINTER : _to->UpdateWindowTitle(aWindow, inTitle); } \
