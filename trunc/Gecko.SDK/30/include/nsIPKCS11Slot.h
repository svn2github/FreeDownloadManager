...
#define NS_DECL_NSIPKCS11SLOT \
  ...
  NS_IMETHOD GetDesc(char16_t * *aDesc); \
  NS_IMETHOD GetManID(char16_t * *aManID); \
  NS_IMETHOD GetHWVersion(char16_t * *aHWVersion); \
  NS_IMETHOD GetFWVersion(char16_t * *aFWVersion); \
...
#define NS_FORWARD_NSIPKCS11SLOT(_to) \
  ...
  NS_IMETHOD GetDesc(char16_t * *aDesc) { return _to GetDesc(aDesc); } \
  NS_IMETHOD GetManID(char16_t * *aManID) { return _to GetManID(aManID); } \
  NS_IMETHOD GetHWVersion(char16_t * *aHWVersion) { return _to GetHWVersion(aHWVersion); } \
  NS_IMETHOD GetFWVersion(char16_t * *aFWVersion) { return _to GetFWVersion(aFWVersion); } \
...
#define NS_FORWARD_SAFE_NSIPKCS11SLOT(_to) \
  ...
  NS_IMETHOD GetDesc(char16_t * *aDesc) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDesc(aDesc); } \
  NS_IMETHOD GetManID(char16_t * *aManID) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetManID(aManID); } \
  NS_IMETHOD GetHWVersion(char16_t * *aHWVersion) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHWVersion(aHWVersion); } \
  NS_IMETHOD GetFWVersion(char16_t * *aFWVersion) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFWVersion(aFWVersion); } \
