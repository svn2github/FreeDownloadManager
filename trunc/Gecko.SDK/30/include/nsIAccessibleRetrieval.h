...
#define NS_DECL_NSIACCESSIBLERETRIEVAL \
  ...
  NS_IMETHOD GetStringStates(uint32_t aStates, uint32_t aExtraStates, nsISupports * *_retval); \
...
#define NS_FORWARD_NSIACCESSIBLERETRIEVAL(_to) \
  ...
  NS_IMETHOD GetStringStates(uint32_t aStates, uint32_t aExtraStates, nsISupports * *_retval) { return _to GetStringStates(aStates, aExtraStates, _retval); } \
...
#define NS_FORWARD_SAFE_NSIACCESSIBLERETRIEVAL(_to) \
  ...
  NS_IMETHOD GetStringStates(uint32_t aStates, uint32_t aExtraStates, nsISupports * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStringStates(aStates, aExtraStates, _retval); } \
