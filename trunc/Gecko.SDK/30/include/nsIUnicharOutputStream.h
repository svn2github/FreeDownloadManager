...
#define NS_DECL_NSIUNICHAROUTPUTSTREAM \
  NS_IMETHOD Write(uint32_t aCount, const char16_t *c, bool *_retval); \
...
#define NS_FORWARD_NSIUNICHAROUTPUTSTREAM(_to) \
  NS_IMETHOD Write(uint32_t aCount, const char16_t *c, bool *_retval) { return _to Write(aCount, c, _retval); } \
...
#define NS_FORWARD_SAFE_NSIUNICHAROUTPUTSTREAM(_to) \
  NS_IMETHOD Write(uint32_t aCount, const char16_t *c, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Write(aCount, c, _retval); } \
