...
#define NS_DECL_NSIPK11TOKENDB \
  ...
  NS_IMETHOD FindTokenByName(const char16_t * tokenName, nsIPK11Token * *_retval); \
...
#define NS_FORWARD_NSIPK11TOKENDB(_to) \
  ...
  NS_IMETHOD FindTokenByName(const char16_t * tokenName, nsIPK11Token * *_retval) { return _to FindTokenByName(tokenName, _retval); } \
...
#define NS_FORWARD_SAFE_NSIPK11TOKENDB(_to) \
  ...
  NS_IMETHOD FindTokenByName(const char16_t * tokenName, nsIPK11Token * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindTokenByName(tokenName, _retval); } \
