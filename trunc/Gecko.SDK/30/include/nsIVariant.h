...
#define NS_DECL_NSIVARIANT \
  ...
  NS_IMETHOD GetAsWChar(char16_t *_retval); \
  ...
  NS_IMETHOD GetAsWString(char16_t * *_retval); \
  NS_IMETHOD GetAsISupports(nsISupports * *_retval); \
  NS_IMETHOD GetAsJSVal(JS::MutableHandleValue _retval); \
  ...
  NS_IMETHOD GetAsWStringWithSize(uint32_t *size, char16_t * *str); 
...
#define NS_FORWARD_NSIVARIANT(_to) \
  ...
  NS_IMETHOD GetAsWChar(char16_t *_retval) { return _to GetAsWChar(_retval); } \
  ...
  NS_IMETHOD GetAsWString(char16_t * *_retval) { return _to GetAsWString(_retval); } \
  NS_IMETHOD GetAsISupports(nsISupports * *_retval) { return _to GetAsISupports(_retval); } \
  NS_IMETHOD GetAsJSVal(JS::MutableHandleValue _retval) { return _to GetAsJSVal(_retval); } \
  ...
  NS_IMETHOD GetAsWStringWithSize(uint32_t *size, char16_t * *str) { return _to GetAsWStringWithSize(size, str); } 
...
#define NS_FORWARD_SAFE_NSIVARIANT(_to) \
  ...
  NS_IMETHOD GetAsWChar(char16_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAsWChar(_retval); } \
  NS_IMETHOD_(nsresult) GetAsID(nsID *retval); \
  ...
  NS_IMETHOD GetAsWString(char16_t * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAsWString(_retval); } \
  NS_IMETHOD GetAsISupports(nsISupports * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAsISupports(_retval); } \
  NS_IMETHOD GetAsJSVal(JS::MutableHandleValue _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAsJSVal(_retval); } \
  ...
  NS_IMETHOD GetAsWStringWithSize(uint32_t *size, char16_t * *str) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAsWStringWithSize(size, str); } 
...
#define NS_DECL_NSIWRITABLEVARIANT \
  ...
  NS_IMETHOD SetAsWChar(char16_t aValue); \
  ...
  NS_IMETHOD SetAsWString(const char16_t * aValue); \
  ...
  NS_IMETHOD SetAsWStringWithSize(uint32_t size, const char16_t * str); \
...
#define NS_FORWARD_NSIWRITABLEVARIANT(_to) \
  ...
  NS_IMETHOD SetAsWChar(char16_t aValue) { return _to SetAsWChar(aValue); } \
  ...
  NS_IMETHOD SetAsWString(const char16_t * aValue) { return _to SetAsWString(aValue); } \
  ...
  NS_IMETHOD SetAsWStringWithSize(uint32_t size, const char16_t * str) { return _to SetAsWStringWithSize(size, str); } \
...
#define NS_FORWARD_SAFE_NSIWRITABLEVARIANT(_to) \
  ...
  NS_IMETHOD SetAsWChar(char16_t aValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAsWChar(aValue); } \
  ...
  NS_IMETHOD SetAsWString(const char16_t * aValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAsWString(aValue); } \
  ...
  NS_IMETHOD SetAsWStringWithSize(uint32_t size, const char16_t * str) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAsWStringWithSize(size, str); } \
