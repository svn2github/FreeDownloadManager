...
#define NS_DECL_INICSSVALUESEARCH \
  ...
  NS_IMETHOD GetBaseURL(char16_t * *aBaseURL); \
  NS_IMETHOD SetBaseURL(const char16_t * aBaseURL); \
  ...
  NS_IMETHOD AddPropertyCriteria(const char16_t * aPropName); \
  NS_IMETHOD GetTextCriteria(char16_t * *aTextCriteria); \
  NS_IMETHOD SetTextCriteria(const char16_t * aTextCriteria); 
...
#define NS_FORWARD_INICSSVALUESEARCH(_to) \
  ...
  NS_IMETHOD GetBaseURL(char16_t * *aBaseURL) { return _to GetBaseURL(aBaseURL); } \
  NS_IMETHOD SetBaseURL(const char16_t * aBaseURL) { return _to SetBaseURL(aBaseURL); } \
  ...
  NS_IMETHOD AddPropertyCriteria(const char16_t * aPropName) { return _to AddPropertyCriteria(aPropName); } \
  NS_IMETHOD GetTextCriteria(char16_t * *aTextCriteria) { return _to GetTextCriteria(aTextCriteria); } \
  NS_IMETHOD SetTextCriteria(const char16_t * aTextCriteria) { return _to SetTextCriteria(aTextCriteria); } 
...
#define NS_FORWARD_SAFE_INICSSVALUESEARCH(_to) \
  ...
  NS_IMETHOD GetBaseURL(char16_t * *aBaseURL) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseURL(aBaseURL); } \
  NS_IMETHOD SetBaseURL(const char16_t * aBaseURL) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetBaseURL(aBaseURL); } \
  ...
  NS_IMETHOD AddPropertyCriteria(const char16_t * aPropName) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddPropertyCriteria(aPropName); } \
  NS_IMETHOD GetTextCriteria(char16_t * *aTextCriteria) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTextCriteria(aTextCriteria); } \
  NS_IMETHOD SetTextCriteria(const char16_t * aTextCriteria) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTextCriteria(aTextCriteria); } 
