...
#define NS_ISELECTIONPRIVATE_IID_STR "52629837-7b3f-4434-940d-a14de7ef9b7a"

#define NS_ISELECTIONPRIVATE_IID \
  {0x52629837, 0x7b3f, 0x4434, \
    { 0x94, 0x0d, 0xa1, 0x4d, 0xe7, 0xef, 0x9b, 0x7a }}
...
#define NS_DECL_NSISELECTIONPRIVATE \
  ...
  NS_IMETHOD SetTextRangeStyle(nsIDOMRange *range, const mozilla::TextRangeStyle & textRangeStyle); \
...
#define NS_FORWARD_NSISELECTIONPRIVATE(_to) \
  ...
  NS_IMETHOD SetTextRangeStyle(nsIDOMRange *range, const mozilla::TextRangeStyle & textRangeStyle) { return _to SetTextRangeStyle(range, textRangeStyle); } \
...
#define NS_FORWARD_SAFE_NSISELECTIONPRIVATE(_to) \
  ...
  NS_IMETHOD SetTextRangeStyle(nsIDOMRange *range, const mozilla::TextRangeStyle & textRangeStyle) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTextRangeStyle(range, textRangeStyle); } \
  NS_IMETHOD_(nsDirection) GetSelectionDirection(void); \
  NS_IMETHOD_(void) SetSelectionDirection(nsDirection aDirection); \
