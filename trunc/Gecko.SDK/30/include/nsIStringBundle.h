...
#define NS_DECL_NSISTRINGBUNDLE \
  NS_IMETHOD GetStringFromID(int32_t aID, char16_t * *_retval); \
  NS_IMETHOD GetStringFromName(const char16_t * aName, char16_t * *_retval); \
  NS_IMETHOD FormatStringFromID(int32_t aID, const char16_t * *params, uint32_t length, char16_t * *_retval); \
  NS_IMETHOD FormatStringFromName(const char16_t * aName, const char16_t * *params, uint32_t length, char16_t * *_retval); \
  NS_IMETHOD GetSimpleEnumeration(nsISimpleEnumerator * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISTRINGBUNDLE(_to) \
  NS_IMETHOD GetStringFromID(int32_t aID, char16_t * *_retval) { return _to GetStringFromID(aID, _retval); } \
  NS_IMETHOD GetStringFromName(const char16_t * aName, char16_t * *_retval) { return _to GetStringFromName(aName, _retval); } \
  NS_IMETHOD FormatStringFromID(int32_t aID, const char16_t * *params, uint32_t length, char16_t * *_retval) { return _to FormatStringFromID(aID, params, length, _retval); } \
  NS_IMETHOD FormatStringFromName(const char16_t * aName, const char16_t * *params, uint32_t length, char16_t * *_retval) { return _to FormatStringFromName(aName, params, length, _retval); } \
...
#define NS_FORWARD_SAFE_NSISTRINGBUNDLE(_to) \
  NS_IMETHOD GetStringFromID(int32_t aID, char16_t * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStringFromID(aID, _retval); } \
  NS_IMETHOD GetStringFromName(const char16_t * aName, char16_t * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStringFromName(aName, _retval); } \
  NS_IMETHOD FormatStringFromID(int32_t aID, const char16_t * *params, uint32_t length, char16_t * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FormatStringFromID(aID, params, length, _retval); } \
  NS_IMETHOD FormatStringFromName(const char16_t * aName, const char16_t * *params, uint32_t length, char16_t * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FormatStringFromName(aName, params, length, _retval); } \
...
#define NS_DECL_NSISTRINGBUNDLESERVICE \
  ...
  NS_IMETHOD FormatStatusMessage(nsresult aStatus, const char16_t * aStatusArg, char16_t * *_retval); \
...
#define NS_FORWARD_NSISTRINGBUNDLESERVICE(_to) \
  ...
  NS_IMETHOD FormatStatusMessage(nsresult aStatus, const char16_t * aStatusArg, char16_t * *_retval) { return _to FormatStatusMessage(aStatus, aStatusArg, _retval); } \
...
#define NS_FORWARD_SAFE_NSISTRINGBUNDLESERVICE(_to) \
  ...
  NS_IMETHOD FormatStatusMessage(nsresult aStatus, const char16_t * aStatusArg, char16_t * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FormatStatusMessage(aStatus, aStatusArg, _retval); } \
