...
#define NS_INAVBOOKMARKSSERVICE_IID_STR "a78ea368-e28e-462e-897a-26606d4ddce6"

#define NS_INAVBOOKMARKSSERVICE_IID \
  {0xa78ea368, 0xe28e, 0x462e, \
    { 0x89, 0x7a, 0x26, 0x60, 0x6d, 0x4d, 0xdc, 0xe6 }}
...
#define NS_DECL_NSINAVBOOKMARKSSERVICE \
  ...
  NS_IMETHOD InsertBookmark(int64_t aParentId, nsIURI *aURI, int32_t aIndex, const nsACString & aTitle, const nsACString & aGUID, int64_t *_retval); \
  NS_IMETHOD RemoveItem(int64_t aItemId); \
  NS_IMETHOD CreateFolder(int64_t aParentFolder, const nsACString & name, int32_t index, const nsACString & aGUID, int64_t *_retval); \
  ...
  NS_IMETHOD InsertSeparator(int64_t aParentId, int32_t aIndex, const nsACString & aGUID, int64_t *_retval); \
...
#define NS_FORWARD_NSINAVBOOKMARKSSERVICE(_to) \
  ...
  NS_IMETHOD InsertBookmark(int64_t aParentId, nsIURI *aURI, int32_t aIndex, const nsACString & aTitle, const nsACString & aGUID, int64_t *_retval) { return _to InsertBookmark(aParentId, aURI, aIndex, aTitle, aGUID, _retval); } \
  NS_IMETHOD RemoveItem(int64_t aItemId) { return _to RemoveItem(aItemId); } \
  NS_IMETHOD CreateFolder(int64_t aParentFolder, const nsACString & name, int32_t index, const nsACString & aGUID, int64_t *_retval) { return _to CreateFolder(aParentFolder, name, index, aGUID, _retval); } \
  ...
  NS_IMETHOD InsertSeparator(int64_t aParentId, int32_t aIndex, const nsACString & aGUID, int64_t *_retval) { return _to InsertSeparator(aParentId, aIndex, aGUID, _retval); } \
...
#define NS_FORWARD_SAFE_NSINAVBOOKMARKSSERVICE(_to) \
  ...
  NS_IMETHOD InsertBookmark(int64_t aParentId, nsIURI *aURI, int32_t aIndex, const nsACString & aTitle, const nsACString & aGUID, int64_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertBookmark(aParentId, aURI, aIndex, aTitle, aGUID, _retval); } \
  NS_IMETHOD RemoveItem(int64_t aItemId) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveItem(aItemId); } \
  NS_IMETHOD CreateFolder(int64_t aParentFolder, const nsACString & name, int32_t index, const nsACString & aGUID, int64_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateFolder(aParentFolder, name, index, aGUID, _retval); } \
  ...
  NS_IMETHOD InsertSeparator(int64_t aParentId, int32_t aIndex, const nsACString & aGUID, int64_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertSeparator(aParentId, aIndex, aGUID, _retval); } \
