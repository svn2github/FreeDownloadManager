...
#define NS_ICONTENTPREFSERVICE2_IID_STR "f2507add-dc39-48e0-9147-e0270376148b"

#define NS_ICONTENTPREFSERVICE2_IID \
  {0xf2507add, 0xdc39, 0x48e0, \
    { 0x91, 0x47, 0xe0, 0x27, 0x03, 0x76, 0x14, 0x8b }}
...
#define NS_DECL_NSICONTENTPREFSERVICE2 \
  NS_IMETHOD GetByName(const nsAString & name, nsILoadContext *context, nsIContentPrefCallback2 *callback); \
...
#define NS_FORWARD_NSICONTENTPREFSERVICE2(_to) \
  NS_IMETHOD GetByName(const nsAString & name, nsILoadContext *context, nsIContentPrefCallback2 *callback) { return _to GetByName(name, context, callback); } \
...
#define NS_FORWARD_SAFE_NSICONTENTPREFSERVICE2(_to) \
  NS_IMETHOD GetByName(const nsAString & name, nsILoadContext *context, nsIContentPrefCallback2 *callback) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetByName(name, context, callback); } \
