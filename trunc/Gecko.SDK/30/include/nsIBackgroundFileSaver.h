...
#define NS_DECL_NSIBACKGROUNDFILESAVER \
  ...
  NS_IMETHOD EnableSignatureInfo(void); \
...
#define NS_FORWARD_NSIBACKGROUNDFILESAVER(_to) \
  ...
  NS_IMETHOD EnableSignatureInfo(void) { return _to EnableSignatureInfo(); } \
...
#define NS_FORWARD_SAFE_NSIBACKGROUNDFILESAVER(_to) \
  ...
  NS_IMETHOD EnableSignatureInfo(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnableSignatureInfo(); } \
