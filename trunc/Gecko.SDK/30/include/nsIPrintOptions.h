...
#define NS_DECL_NSIPRINTOPTIONS \
  ...
  NS_IMETHOD GetPrinterPrefInt(nsIPrintSettings *aPrintSettings, const char16_t * aPrefName, int32_t *_retval); \
  NS_IMETHOD DisplayJobProperties(const char16_t * aPrinter, nsIPrintSettings *aPrintSettings, bool *aDisplayed); \
...
#define NS_FORWARD_NSIPRINTOPTIONS(_to) \
  ...
  NS_IMETHOD GetPrinterPrefInt(nsIPrintSettings *aPrintSettings, const char16_t * aPrefName, int32_t *_retval) { return _to GetPrinterPrefInt(aPrintSettings, aPrefName, _retval); } \
  NS_IMETHOD DisplayJobProperties(const char16_t * aPrinter, nsIPrintSettings *aPrintSettings, bool *aDisplayed) { return _to DisplayJobProperties(aPrinter, aPrintSettings, aDisplayed); } \
...
#define NS_FORWARD_SAFE_NSIPRINTOPTIONS(_to) \
  ...
  NS_IMETHOD GetPrinterPrefInt(nsIPrintSettings *aPrintSettings, const char16_t * aPrefName, int32_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrinterPrefInt(aPrintSettings, aPrefName, _retval); } \
  NS_IMETHOD DisplayJobProperties(const char16_t * aPrinter, nsIPrintSettings *aPrintSettings, bool *aDisplayed) { return !_to ? NS_ERROR_NULL_POINTER : _to->DisplayJobProperties(aPrinter, aPrintSettings, aDisplayed); } \
...
#define NS_DECL_NSIPRINTERENUMERATOR \
  ...
  NS_IMETHOD InitPrintSettingsFromPrinter(const char16_t * aPrinterName, nsIPrintSettings *aPrintSettings); \
  NS_IMETHOD GetPrinterNameList(nsIStringEnumerator * *aPrinterNameList); \
  NS_IMETHOD DisplayPropertiesDlg(const char16_t * aPrinter, nsIPrintSettings *aPrintSettings); 
...
#define NS_FORWARD_NSIPRINTERENUMERATOR(_to) \
  ...
  NS_IMETHOD InitPrintSettingsFromPrinter(const char16_t * aPrinterName, nsIPrintSettings *aPrintSettings) { return _to InitPrintSettingsFromPrinter(aPrinterName, aPrintSettings); } \
  NS_IMETHOD GetPrinterNameList(nsIStringEnumerator * *aPrinterNameList) { return _to GetPrinterNameList(aPrinterNameList); } \
  NS_IMETHOD DisplayPropertiesDlg(const char16_t * aPrinter, nsIPrintSettings *aPrintSettings) { return _to DisplayPropertiesDlg(aPrinter, aPrintSettings); } 
...
#define NS_FORWARD_SAFE_NSIPRINTERENUMERATOR(_to) \
  ...
  NS_IMETHOD InitPrintSettingsFromPrinter(const char16_t * aPrinterName, nsIPrintSettings *aPrintSettings) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitPrintSettingsFromPrinter(aPrinterName, aPrintSettings); } \
  ...
  NS_IMETHOD DisplayPropertiesDlg(const char16_t * aPrinter, nsIPrintSettings *aPrintSettings) { return !_to ? NS_ERROR_NULL_POINTER : _to->DisplayPropertiesDlg(aPrinter, aPrintSettings); } 
