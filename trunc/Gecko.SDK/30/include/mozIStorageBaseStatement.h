...
#define MOZISTORAGEBASESTATEMENT_IID_STR "5d34f333-ed3f-4aa2-ba51-f2a8b0cfa33a"

#define MOZISTORAGEBASESTATEMENT_IID \
  {0x5d34f333, 0xed3f, 0x4aa2, \
    { 0xba, 0x51, 0xf2, 0xa8, 0xb0, 0xcf, 0xa3, 0x3a }}
...
#define NS_DECL_MOZISTORAGEBASESTATEMENT \
  ...
  NS_IMETHOD BindAdoptedBlobParameter(uint32_t aParamIndex, uint8_t *aValue, uint32_t aValueSize); \
  ...
  NS_IMETHOD EscapeStringForLIKE(const nsAString & aValue, char16_t aEscapeChar, nsAString & _retval); 
...
#define NS_FORWARD_MOZISTORAGEBASESTATEMENT(_to) \
  ...
  NS_IMETHOD BindAdoptedBlobParameter(uint32_t aParamIndex, uint8_t *aValue, uint32_t aValueSize) { return _to BindAdoptedBlobParameter(aParamIndex, aValue, aValueSize); } \
  ...
  NS_IMETHOD EscapeStringForLIKE(const nsAString & aValue, char16_t aEscapeChar, nsAString & _retval) { return _to EscapeStringForLIKE(aValue, aEscapeChar, _retval); } 
...
#define NS_FORWARD_SAFE_MOZISTORAGEBASESTATEMENT(_to) \
  ...
  NS_IMETHOD BindAdoptedBlobParameter(uint32_t aParamIndex, uint8_t *aValue, uint32_t aValueSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->BindAdoptedBlobParameter(aParamIndex, aValue, aValueSize); } \
  ...
  NS_IMETHOD EscapeStringForLIKE(const nsAString & aValue, char16_t aEscapeChar, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EscapeStringForLIKE(aValue, aEscapeChar, _retval); } 
