...
#define NS_DECL_NSIAPPLICATIONCACHESERVICE \
  NS_IMETHOD BuildGroupID(nsIURI *aManifestURL, nsILoadContextInfo *aLoadContextInfo, nsACString & _retval); \
  ...
  NS_IMETHOD ChooseApplicationCache(const nsACString & key, nsILoadContextInfo *aLoadContextInfo, nsIApplicationCache * *_retval); \
...
#define NS_FORWARD_NSIAPPLICATIONCACHESERVICE(_to) \
  NS_IMETHOD BuildGroupID(nsIURI *aManifestURL, nsILoadContextInfo *aLoadContextInfo, nsACString & _retval) { return _to BuildGroupID(aManifestURL, aLoadContextInfo, _retval); } \
  ...
  NS_IMETHOD ChooseApplicationCache(const nsACString & key, nsILoadContextInfo *aLoadContextInfo, nsIApplicationCache * *_retval) { return _to ChooseApplicationCache(key, aLoadContextInfo, _retval); } \
...
#define NS_FORWARD_SAFE_NSIAPPLICATIONCACHESERVICE(_to) \
  NS_IMETHOD BuildGroupID(nsIURI *aManifestURL, nsILoadContextInfo *aLoadContextInfo, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->BuildGroupID(aManifestURL, aLoadContextInfo, _retval); } \
  ...
  NS_IMETHOD ChooseApplicationCache(const nsACString & key, nsILoadContextInfo *aLoadContextInfo, nsIApplicationCache * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ChooseApplicationCache(key, aLoadContextInfo, _retval); } \
