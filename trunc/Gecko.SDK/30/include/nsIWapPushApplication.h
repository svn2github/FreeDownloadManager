...
#define NS_DECL_NSIWAPPUSHAPPLICATION \
  NS_IMETHOD ReceiveWapPush(uint8_t *aData, uint32_t aLength, uint32_t aOffset, JS::HandleValue aOptions); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWAPPUSHAPPLICATION(_to) \
  NS_IMETHOD ReceiveWapPush(uint8_t *aData, uint32_t aLength, uint32_t aOffset, JS::HandleValue aOptions) { return _to ReceiveWapPush(aData, aLength, aOffset, aOptions); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWAPPUSHAPPLICATION(_to) \
  NS_IMETHOD ReceiveWapPush(uint8_t *aData, uint32_t aLength, uint32_t aOffset, JS::HandleValue aOptions) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReceiveWapPush(aData, aLength, aOffset, aOptions); } 
