...
MOZ_BEGIN_ENUM_CLASS(BinaryType, uint32_t)
  Blob,
  Arraybuffer
MOZ_END_ENUM_CLASS(BinaryType)
...
namespace WebSocketBinding {
  ...
  JSObject*
  Wrap(JSContext* aCx, JS::Handle<JSObject*> aScope, mozilla::dom::WebSocket* aObject, nsWrapperCache* aCache);
