...
#ifndef mozilla_dom_MessageEventBinding_h__
#define mozilla_dom_MessageEventBinding_h__
...
struct MessageEventInit : public EventInit
{
  ...
  Nullable<OwningWindowProxyOrMessagePort > mSource;

  MessageEventInit();

protected:
  explicit inline MessageEventInit(int )
...
private:
  MessageEventInit(const MessageEventInit&) MOZ_DELETE;
  void operator=(const MessageEventInit) MOZ_DELETE;
...
namespace MessageEventBinding {
  ...
  JSObject*
  Wrap(JSContext* aCx, JS::Handle<JSObject*> aScope, mozilla::dom::MessageEvent* aObject, nsWrapperCache* aCache);
...
#endif // mozilla_dom_MessageEventBinding_h__
