...
#ifndef mozilla_dom_GamepadEventBinding_h__
#define mozilla_dom_GamepadEventBinding_h__
...
{
  nsRefPtr<mozilla::dom::Gamepad> mGamepad;

  GamepadEventInit();

protected:
  explicit inline GamepadEventInit(int )
  {
    // Do nothing here; this is used by our "Fast" subclass
  }

private:
  GamepadEventInit(const GamepadEventInit&) MOZ_DELETE;
  void operator=(const GamepadEventInit) MOZ_DELETE;
...
namespace GamepadEventBinding {
  ...
  JSObject*
  Wrap(JSContext* aCx, JS::Handle<JSObject*> aScope, mozilla::dom::GamepadEvent* aObject, nsWrapperCache* aCache);
...
#endif // mozilla_dom_GamepadEventBinding_h__
