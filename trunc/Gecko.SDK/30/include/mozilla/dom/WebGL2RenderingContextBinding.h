...
#ifndef mozilla_dom_WebGL2RenderingContextBinding_h__
#define mozilla_dom_WebGL2RenderingContextBinding_h__
...
namespace WebGLQueryBinding {
  ...
  JSObject*
  Wrap(JSContext* aCx, JS::Handle<JSObject*> aScope, mozilla::WebGLQuery* aObject, nsWrapperCache* aCache);
...
#endif // mozilla_dom_WebGL2RenderingContextBinding_h__
