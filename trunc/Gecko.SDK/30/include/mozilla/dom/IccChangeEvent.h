...
#ifndef mozilla_dom_IccChangeEvent_h__
#define mozilla_dom_IccChangeEvent_h__
...
protected:
  IccChangeEvent(mozilla::dom::EventTarget* aOwner);

  nsString mIccId;

public:
  virtual IccChangeEvent* AsIccChangeEvent();
...
#endif // mozilla_dom_IccChangeEvent_h__
