...
#ifndef mozilla_dom_IDBIndexBinding_h__
#define mozilla_dom_IDBIndexBinding_h__
...
protected:
  explicit inline IDBIndexParameters(int )
  {
...
namespace IDBIndexBinding {
  ...
  JSObject*
  Wrap(JSContext* aCx, JS::Handle<JSObject*> aScope, mozilla::dom::indexedDB::IDBIndex* aObject, nsWrapperCache* aCache);
...
#endif // mozilla_dom_IDBIndexBinding_h__
