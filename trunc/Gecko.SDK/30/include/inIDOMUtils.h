...
#define NS_DECL_INIDOMUTILS \
  ...
  NS_IMETHOD GetCSSPropertyNames(uint32_t aFlags, uint32_t *aCount, char16_t * **aProps); \
  NS_IMETHOD GetCSSValuesForProperty(const nsAString & aProperty, uint32_t *aLength, char16_t * **aValues); \
  NS_IMETHOD ColorNameToRGB(const nsAString & aColorName, JSContext* cx, JS::MutableHandleValue _retval); \
...
#define NS_FORWARD_INIDOMUTILS(_to) \
  ...
  NS_IMETHOD GetCSSPropertyNames(uint32_t aFlags, uint32_t *aCount, char16_t * **aProps) { return _to GetCSSPropertyNames(aFlags, aCount, aProps); } \
  NS_IMETHOD GetCSSValuesForProperty(const nsAString & aProperty, uint32_t *aLength, char16_t * **aValues) { return _to GetCSSValuesForProperty(aProperty, aLength, aValues); } \
  NS_IMETHOD ColorNameToRGB(const nsAString & aColorName, JSContext* cx, JS::MutableHandleValue _retval) { return _to ColorNameToRGB(aColorName, cx, _retval); } \
...
#define NS_FORWARD_SAFE_INIDOMUTILS(_to) \
  ...
  NS_IMETHOD GetCSSPropertyNames(uint32_t aFlags, uint32_t *aCount, char16_t * **aProps) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCSSPropertyNames(aFlags, aCount, aProps); } \
  NS_IMETHOD GetCSSValuesForProperty(const nsAString & aProperty, uint32_t *aLength, char16_t * **aValues) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCSSValuesForProperty(aProperty, aLength, aValues); } \
  NS_IMETHOD ColorNameToRGB(const nsAString & aColorName, JSContext* cx, JS::MutableHandleValue _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ColorNameToRGB(aColorName, cx, _retval); } \
