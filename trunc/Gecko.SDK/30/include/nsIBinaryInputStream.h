...
class NS_NO_VTABLE nsIBinaryInputStream : public nsIInputStream {
 public: 
  ...
  NS_IMETHOD ReadArrayBuffer(uint32_t aLength, JS::HandleValue aArrayBuffer, JSContext* cx) = 0;
...
#define NS_DECL_NSIBINARYINPUTSTREAM \
  ...
  NS_IMETHOD ReadArrayBuffer(uint32_t aLength, JS::HandleValue aArrayBuffer, JSContext* cx); 
...
#define NS_FORWARD_NSIBINARYINPUTSTREAM(_to) \
  ...
  NS_IMETHOD ReadArrayBuffer(uint32_t aLength, JS::HandleValue aArrayBuffer, JSContext* cx) { return _to ReadArrayBuffer(aLength, aArrayBuffer, cx); } 
...
#define NS_FORWARD_SAFE_NSIBINARYINPUTSTREAM(_to) \
  ...
  NS_IMETHOD ReadArrayBuffer(uint32_t aLength, JS::HandleValue aArrayBuffer, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadArrayBuffer(aLength, aArrayBuffer, cx); } 
...
/* [implicit_jscontext] void readArrayBuffer (in uint32_t aLength, in jsval aArrayBuffer); */
NS_IMETHODIMP nsBinaryInputStream::ReadArrayBuffer(uint32_t aLength, JS::HandleValue aArrayBuffer, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
