...
#define NS_DECL_NSIGIOSERVICE \
  ...
  NS_IMETHOD OrgFreedesktopFileManager1ShowItems(const nsACString & path); 
...
#define NS_FORWARD_NSIGIOSERVICE(_to) \
  ...
  NS_IMETHOD OrgFreedesktopFileManager1ShowItems(const nsACString & path) { return _to OrgFreedesktopFileManager1ShowItems(path); } 
...
#define NS_FORWARD_SAFE_NSIGIOSERVICE(_to) \
  ...
  NS_IMETHOD OrgFreedesktopFileManager1ShowItems(const nsACString & path) { return !_to ? NS_ERROR_NULL_POINTER : _to->OrgFreedesktopFileManager1ShowItems(path); } 
