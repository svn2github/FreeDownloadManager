...
#define MOZISTORAGEBINDINGPARAMS_IID_STR "7d8763ad-79d9-4674-ada1-37fd702af68c"

#define MOZISTORAGEBINDINGPARAMS_IID \
  {0x7d8763ad, 0x79d9, 0x4674, \
    { 0xad, 0xa1, 0x37, 0xfd, 0x70, 0x2a, 0xf6, 0x8c }}
...
#define NS_DECL_MOZISTORAGEBINDINGPARAMS \
  ...
  NS_IMETHOD BindAdoptedBlobByName(const nsACString & aName, uint8_t *aValue, uint32_t aValueSize); \
  ...
  NS_IMETHOD BindAdoptedBlobByIndex(uint32_t aIndex, uint8_t *aValue, uint32_t aValueSize); 
...
#define NS_FORWARD_MOZISTORAGEBINDINGPARAMS(_to) \
  ...
  NS_IMETHOD BindAdoptedBlobByName(const nsACString & aName, uint8_t *aValue, uint32_t aValueSize) { return _to BindAdoptedBlobByName(aName, aValue, aValueSize); } \
  ...
  NS_IMETHOD BindAdoptedBlobByIndex(uint32_t aIndex, uint8_t *aValue, uint32_t aValueSize) { return _to BindAdoptedBlobByIndex(aIndex, aValue, aValueSize); } 
...
#define NS_FORWARD_SAFE_MOZISTORAGEBINDINGPARAMS(_to) \
  ...
  NS_IMETHOD BindAdoptedBlobByName(const nsACString & aName, uint8_t *aValue, uint32_t aValueSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->BindAdoptedBlobByName(aName, aValue, aValueSize); } \
  ...
  NS_IMETHOD BindAdoptedBlobByIndex(uint32_t aIndex, uint8_t *aValue, uint32_t aValueSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->BindAdoptedBlobByIndex(aIndex, aValue, aValueSize); } 
