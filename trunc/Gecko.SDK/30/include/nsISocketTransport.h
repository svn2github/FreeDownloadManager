...
#define NS_ISOCKETTRANSPORT_IID_STR "3f41704c-cd5d-4537-8c4c-7b2ebfc5d972"

#define NS_ISOCKETTRANSPORT_IID \
  {0x3f41704c, 0xcd5d, 0x4537, \
    { 0x8c, 0x4c, 0x7b, 0x2e, 0xbf, 0xc5, 0xd9, 0x72 }}
...
#define NS_DECL_NSISOCKETTRANSPORT \
  ...
  NS_IMETHOD GetKeepaliveEnabled(bool *aKeepaliveEnabled); \
  NS_IMETHOD SetKeepaliveEnabled(bool aKeepaliveEnabled); \
  NS_IMETHOD SetKeepaliveVals(int32_t keepaliveIdleTime, int32_t keepaliveRetryInterval); 
...
#define NS_FORWARD_NSISOCKETTRANSPORT(_to) \
  ...
  NS_IMETHOD GetKeepaliveEnabled(bool *aKeepaliveEnabled) { return _to GetKeepaliveEnabled(aKeepaliveEnabled); } \
  NS_IMETHOD SetKeepaliveEnabled(bool aKeepaliveEnabled) { return _to SetKeepaliveEnabled(aKeepaliveEnabled); } \
  NS_IMETHOD SetKeepaliveVals(int32_t keepaliveIdleTime, int32_t keepaliveRetryInterval) { return _to SetKeepaliveVals(keepaliveIdleTime, keepaliveRetryInterval); } 
...
#define NS_FORWARD_SAFE_NSISOCKETTRANSPORT(_to) \
  ...
  NS_IMETHOD GetKeepaliveEnabled(bool *aKeepaliveEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKeepaliveEnabled(aKeepaliveEnabled); } \
  NS_IMETHOD SetKeepaliveEnabled(bool aKeepaliveEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetKeepaliveEnabled(aKeepaliveEnabled); } \
  NS_IMETHOD SetKeepaliveVals(int32_t keepaliveIdleTime, int32_t keepaliveRetryInterval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetKeepaliveVals(keepaliveIdleTime, keepaliveRetryInterval); } 
