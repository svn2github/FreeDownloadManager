...
#define NS_DECL_NSIPRINTPROGRESSPARAMS \
  NS_IMETHOD GetDocTitle(char16_t * *aDocTitle); \
  NS_IMETHOD SetDocTitle(const char16_t * aDocTitle); \
...
#define NS_FORWARD_NSIPRINTPROGRESSPARAMS(_to) \
  NS_IMETHOD GetDocTitle(char16_t * *aDocTitle) { return _to GetDocTitle(aDocTitle); } \
  NS_IMETHOD SetDocTitle(const char16_t * aDocTitle) { return _to SetDocTitle(aDocTitle); } \
...
#define NS_FORWARD_SAFE_NSIPRINTPROGRESSPARAMS(_to) \
  NS_IMETHOD GetDocTitle(char16_t * *aDocTitle) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDocTitle(aDocTitle); } \
  NS_IMETHOD SetDocTitle(const char16_t * aDocTitle) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDocTitle(aDocTitle); } \
