...
#define NS_DECL_NSICURRENTCHARSETLISTENER \
  NS_IMETHOD SetCurrentCharset(const char16_t * charset); \
  NS_IMETHOD SetCurrentMailCharset(const char16_t * charset); \
  NS_IMETHOD SetCurrentComposerCharset(const char16_t * charset); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICURRENTCHARSETLISTENER(_to) \
  NS_IMETHOD SetCurrentCharset(const char16_t * charset) { return _to SetCurrentCharset(charset); } \
  NS_IMETHOD SetCurrentMailCharset(const char16_t * charset) { return _to SetCurrentMailCharset(charset); } \
  NS_IMETHOD SetCurrentComposerCharset(const char16_t * charset) { return _to SetCurrentComposerCharset(charset); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICURRENTCHARSETLISTENER(_to) \
  NS_IMETHOD SetCurrentCharset(const char16_t * charset) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCurrentCharset(charset); } \
  NS_IMETHOD SetCurrentMailCharset(const char16_t * charset) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCurrentMailCharset(charset); } \
  NS_IMETHOD SetCurrentComposerCharset(const char16_t * charset) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCurrentComposerCharset(charset); } 
