...
#define NS_DECL_NSITREECOLUMN \
  ...
  NS_IMETHOD GetIdConst(const char16_t * *idConst); \
...
#define NS_FORWARD_NSITREECOLUMN(_to) \
  ...
  NS_IMETHOD GetIdConst(const char16_t * *idConst) { return _to GetIdConst(idConst); } \
...
#define NS_FORWARD_SAFE_NSITREECOLUMN(_to) \
  ...
  NS_IMETHOD GetIdConst(const char16_t * *idConst) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIdConst(idConst); } \
