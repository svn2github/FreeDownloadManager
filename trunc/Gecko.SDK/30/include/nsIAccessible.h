...
#define NS_IACCESSIBLE_IID_STR "ee62158b-bb83-424b-a88d-d7d7f9cf460d"

#define NS_IACCESSIBLE_IID \
  {0xee62158b, 0xbb83, 0x424b, \
    { 0xa8, 0x8d, 0xd7, 0xd7, 0xf9, 0xcf, 0x46, 0x0d }}
...
class NS_NO_VTABLE nsIAccessible : public nsISupports {
 public: 
  ...
  /* [binaryname(ScriptableGroupPosition)] void groupPosition (out long aGroupLevel, out long aSimilarItemsInGroup, out long aPositionInGroup); */
  NS_IMETHOD ScriptableGroupPosition(int32_t *aGroupLevel, int32_t *aSimilarItemsInGroup, int32_t *aPositionInGroup) = 0;
...
#define NS_DECL_NSIACCESSIBLE \
  ...
  NS_IMETHOD ScriptableGroupPosition(int32_t *aGroupLevel, int32_t *aSimilarItemsInGroup, int32_t *aPositionInGroup); \
...
#define NS_FORWARD_NSIACCESSIBLE(_to) \
  ...
  NS_IMETHOD ScriptableGroupPosition(int32_t *aGroupLevel, int32_t *aSimilarItemsInGroup, int32_t *aPositionInGroup) { return _to ScriptableGroupPosition(aGroupLevel, aSimilarItemsInGroup, aPositionInGroup); } \
...
#define NS_FORWARD_SAFE_NSIACCESSIBLE(_to) \
  ...
  NS_IMETHOD ScriptableGroupPosition(int32_t *aGroupLevel, int32_t *aSimilarItemsInGroup, int32_t *aPositionInGroup) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScriptableGroupPosition(aGroupLevel, aSimilarItemsInGroup, aPositionInGroup); } \
...
/* [binaryname(ScriptableGroupPosition)] void groupPosition (out long aGroupLevel, out long aSimilarItemsInGroup, out long aPositionInGroup); */
NS_IMETHODIMP nsAccessible::ScriptableGroupPosition(int32_t *aGroupLevel, int32_t *aSimilarItemsInGroup, int32_t *aPositionInGroup)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
