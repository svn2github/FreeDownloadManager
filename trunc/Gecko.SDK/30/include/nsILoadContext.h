...
#define NS_ILOADCONTEXT_IID_STR "852ed1f0-8ec0-11e3-baa8-0800200c9a66"

#define NS_ILOADCONTEXT_IID \
  {0x852ed1f0, 0x8ec0, 0x11e3, \
...
#define NS_DECL_NSILOADCONTEXT \
  ...
  NS_IMETHOD GetUseRemoteTabs(bool *aUseRemoteTabs); \
  NS_IMETHOD SetPrivateBrowsing(bool aInPrivateBrowsing); \
  NS_IMETHOD SetRemoteTabs(bool aUseRemoteTabs); \
...
#define NS_FORWARD_NSILOADCONTEXT(_to) \
  ...
  NS_IMETHOD GetUseRemoteTabs(bool *aUseRemoteTabs) { return _to GetUseRemoteTabs(aUseRemoteTabs); } \
  NS_IMETHOD SetPrivateBrowsing(bool aInPrivateBrowsing) { return _to SetPrivateBrowsing(aInPrivateBrowsing); } \
  NS_IMETHOD SetRemoteTabs(bool aUseRemoteTabs) { return _to SetRemoteTabs(aUseRemoteTabs); } \
...
#define NS_FORWARD_SAFE_NSILOADCONTEXT(_to) \
  ...
  NS_IMETHOD GetUseRemoteTabs(bool *aUseRemoteTabs) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUseRemoteTabs(aUseRemoteTabs); } \
  ...
  NS_IMETHOD SetRemoteTabs(bool aUseRemoteTabs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetRemoteTabs(aUseRemoteTabs); } \
