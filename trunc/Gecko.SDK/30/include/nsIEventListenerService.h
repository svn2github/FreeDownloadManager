...
#define NS_DECL_NSIEVENTLISTENERINFO \
  ...
  NS_IMETHOD GetListenerObject(JSContext* cx, JS::MutableHandleValue aListenerObject); \
...
#define NS_FORWARD_NSIEVENTLISTENERINFO(_to) \
  ...
  NS_IMETHOD GetListenerObject(JSContext* cx, JS::MutableHandleValue aListenerObject) { return _to GetListenerObject(cx, aListenerObject); } \
...
#define NS_FORWARD_SAFE_NSIEVENTLISTENERINFO(_to) \
  ...
  NS_IMETHOD GetListenerObject(JSContext* cx, JS::MutableHandleValue aListenerObject) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetListenerObject(cx, aListenerObject); } \
