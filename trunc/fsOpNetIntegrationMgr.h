...
{
public:
	LPCSTR getChromePluginPath () const;
	LPCSTR getSafariPluginPath () const;
	LPCSTR getMozillaSuitePluginPath () const;
	LPCSTR getNetscapePluginPath () const;
	LPCSTR getOperaPluginPath () const;
